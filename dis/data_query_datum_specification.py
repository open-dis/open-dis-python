...
from .unsigned_disinteger import UnsignedDISInteger
...
class DataQueryDatumSpecification( object ):
    ...
    def add_fixedDatumIDList(self, value : UnsignedDISInteger):
    ...
    ///             UID : 
    ///            Type : UnsignedDISInteger
    ///            Kind : OBJECT_LIST
    ///    Marshal Size : 8
    ///         Comment : variable length list fixed datum IDs
    ///   default value : null
    ///     is Bitfield : false
    ///     List Length : 0
    ///     Prim Length : false
    ...
    def add_variableDatumIDList(self, value : UnsignedDISInteger):
    ...
    ///            Kind : OBJECT_LIST
    ///    Marshal Size : 8
    ///         Comment : variable length list variable datum IDs
    ///   default value : null
    ///     is Bitfield : false
    ///     List Length : 0
    ///     Prim Length : false
