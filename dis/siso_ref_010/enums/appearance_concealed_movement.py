...
class AppearanceConcealedMovement(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    open_movement = EnumValue(0, "Open Movement")
    rushes_between_covered_positions = EnumValue(1, "Rushes Between Covered Positions")
    default = open_movement
