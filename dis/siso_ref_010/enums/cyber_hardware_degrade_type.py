...
class CyberHardwareDegradeType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    keyboard = EnumValue(1, "Keyboard")
    mouse = EnumValue(2, "Mouse")
    display = EnumValue(3, "Display")
    sound = EnumValue(4, "Sound")
    kernel_panic = EnumValue(5, "Kernel Panic")
    random_text = EnumValue(6, "Random Text")
    reboot = EnumValue(7, "Reboot")
    default = keyboard
