...
class VariableParameterRecordType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    articulated_part = EnumValue(0, "Articulated Part")
    attached_part = EnumValue(1, "Attached Part")
    separation = EnumValue(2, "Separation")
    entity_type = EnumValue(3, "Entity Type")
    entity_association = EnumValue(4, "Entity Association")
    default = articulated_part
