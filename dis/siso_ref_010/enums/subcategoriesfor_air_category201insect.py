...
class SubcategoriesforAirCategory201Insect(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    moth = EnumValue(1, "Moth")
    butterfly = EnumValue(2, "Butterfly")
    fly = EnumValue(20, "Fly")
    mosquito = EnumValue(30, "Mosquito")
    wasp = EnumValue(40, "Wasp")
    bee = EnumValue(50, "Bee")
    beetle = EnumValue(60, "Beetle")
    dragonfly = EnumValue(70, "Dragonfly")
    locust = EnumValue(80, "Locust")
    default = moth
