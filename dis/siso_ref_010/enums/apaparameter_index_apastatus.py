...
class APAParameterIndexAPAStatus(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    deselected_off = EnumValue(0, "Deselected/Off")
    apa_value_change_only = EnumValue(1, "APA Value Change Only")
    state_change = EnumValue(2, "State Change")
    record_activation = EnumValue(3, "Record Activation")
    default = deselected_off
