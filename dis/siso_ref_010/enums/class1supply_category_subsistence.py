...
class Class1SupplyCategorySubsistence(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(1, "Other")
    a_non_perishable = EnumValue(2, "A - Non-Perishable")
    c_combat_rations = EnumValue(3, "C - Combat Rations")
    r_refrigerated = EnumValue(4, "R - Refrigerated")
    s_other_non_refrigerated = EnumValue(5, "S - Other Non-Refrigerated")
    w_water = EnumValue(6, "W - Water")
    default = other
