...
class LifeFormSubsurfaceCategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    # XREF UID 120 - CLASS SubcategoriesforSubsurfaceCategory200Fish 
    fish = EnumValue(200, "Fish")
    # XREF UID 121 - CLASS SubcategoriesforSubsurfaceCategory201Mammal 
    mammal = EnumValue(201, "Mammal")
    # XREF UID 122 - CLASS SubcategoriesforSubsurfaceCategory202Mollusk 
    mollusk = EnumValue(202, "Mollusk")
    # XREF UID 123 - CLASS SubcategoriesforSubsurfaceCategory203Crustacean 
    crustacean = EnumValue(203, "Crustacean")
    # XREF UID 124 - CLASS SubcategoriesforSubsurfaceCategory204Insect 
    insect = EnumValue(204, "Insect")
    default = fish
