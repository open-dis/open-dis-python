...
class PlatformLandTrainsSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    engine_locomotive = EnumValue(1, "Engine (Locomotive)")
    box_car = EnumValue(2, "Box Car")
    tanker = EnumValue(3, "Tanker")
    flatcar = EnumValue(4, "Flatcar")
    caboose = EnumValue(5, "Caboose")
    passenger_car = EnumValue(6, "Passenger Car")
    hopper = EnumValue(7, "Hopper")
    default = other
