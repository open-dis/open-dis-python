...
class LifeSavingEquipment(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    lifeboat = EnumValue(1, "Lifeboat")
    liferaft = EnumValue(2, "Liferaft")
    mob_boat = EnumValue(3, "MOB Boat")
    lifebuoy = EnumValue(4, "Lifebuoy")
    default = lifeboat
