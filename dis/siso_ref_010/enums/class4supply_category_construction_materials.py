...
class Class4SupplyCategoryConstructionMaterials(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(1, "Other")
    a_construction = EnumValue(2, "A - Construction")
    b_barrier = EnumValue(3, "B - Barrier")
    default = other
