...
class TransmitterDetailAnglemodulation(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    fm_frequency_modulation = EnumValue(1, "FM (Frequency Modulation)")
    fsk_frequency_shift_keying = EnumValue(2, "FSK (Frequency Shift Keying)")
    pm_phase_modulation = EnumValue(3, "PM (Phase Modulation)")
    msk_minimum_shift_keying = EnumValue(4, "MSK (Minimum Shift Keying)")
    default = other
