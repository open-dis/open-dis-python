...
class RepairResponseRepairResult(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "other")
    repair_ended = EnumValue(1, "repair ended")
    invalid_repair = EnumValue(2, "invalid repair")
    repair_interrupted = EnumValue(3, "repair interrupted")
    service_canceled_by_the_supplier = EnumValue(4, "service canceled by the supplier")
    default = other
