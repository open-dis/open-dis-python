...
class Link11DataTerminalSetIndicator(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    transmit = EnumValue(1, "Transmit")
    receive = EnumValue(2, "Receive")
    net_busy = EnumValue(3, "Net Busy")
    transmit_data_error = EnumValue(4, "Transmit Data Error")
    receive_data_error = EnumValue(5, "Receive Data Error")
    code_error = EnumValue(6, "Code Error")
    synchronization_complete = EnumValue(7, "Synchronization Complete")
