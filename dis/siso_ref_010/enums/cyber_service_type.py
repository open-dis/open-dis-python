...
class CyberServiceType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    dns = EnumValue(1, "DNS")
    email = EnumValue(2, "Email")
    web = EnumValue(3, "Web")
    database = EnumValue(4, "Database")
    file = EnumValue(5, "File")
    chat = EnumValue(6, "Chat")
    forum = EnumValue(7, "Forum")
    social_media = EnumValue(8, "Social Media")
    containerization = EnumValue(9, "Containerization")
    virtualization = EnumValue(10, "Virtualization")
    network_time = EnumValue(11, "Network Time")
    default = dns
