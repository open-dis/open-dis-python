...
class ComponentVisualDamageStatusSmoke(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_smoke = EnumValue(0, "No Smoke")
    light_smoke = EnumValue(1, "Light Smoke")
    moderate_smoke = EnumValue(2, "Moderate Smoke")
    heavy_smoke = EnumValue(3, "Heavy Smoke")
    default = no_smoke
