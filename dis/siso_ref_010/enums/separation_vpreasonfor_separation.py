...
class SeparationVPReasonforSeparation(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    attached_part_separation = EnumValue(1, "Attached Part Separation")
    submunition_separation = EnumValue(2, "Submunition Separation")
