...
class IntercomControlDestinationLineStateCommand(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    none = EnumValue(0, "None")
    set_line_state_transmitting = EnumValue(1, "Set Line State - Transmitting")
    set_line_state_not_transmitting = EnumValue(2, "Set Line State - Not Transmitting")
    return_to_local_line_state_control = EnumValue(3, "Return to Local Line State Control")
    default = none
