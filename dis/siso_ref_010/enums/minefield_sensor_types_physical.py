...
class MinefieldSensorTypesPhysical(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    generic_probe = EnumValue(0, "Generic Probe")
    probe_metal_content = EnumValue(1, "Probe, metal content")
    probe_no_metal_content = EnumValue(2, "Probe, no metal content")
