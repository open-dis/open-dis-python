...
class DEDamageDescriptionComponentVisualSmokeColor(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_smoke = EnumValue(0, "No Smoke")
    white = EnumValue(1, "White")
    gray = EnumValue(2, "Gray")
    black = EnumValue(3, "Black")
    default = no_smoke
