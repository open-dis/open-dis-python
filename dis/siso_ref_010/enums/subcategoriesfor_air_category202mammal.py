...
class SubcategoriesforAirCategory202Mammal(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    bat = EnumValue(1, "Bat")
    flying_squirrel = EnumValue(10, "Flying Squirrel")
    gliding_possum = EnumValue(20, "Gliding Possum")
    default = bat
