...
class EnvironmentalSubcategory(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    very_small = EnumValue(20, "Very Small")
    small = EnumValue(40, "Small")
    medium = EnumValue(60, "Medium")
    large = EnumValue(80, "Large")
    very_large = EnumValue(100, "Very Large")
    default = other
