...
class IntercomControlControlType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    reserved = EnumValue(0, "Reserved")
    status = EnumValue(1, "Status")
    request_acknowledge_required = EnumValue(2, "Request - Acknowledge Required")
    request_no_acknowledge = EnumValue(3, "Request - No Acknowledge")
    ack_request_granted = EnumValue(4, "Ack - Request Granted")
    nack_request_denied = EnumValue(5, "Nack - Request Denied")
    default = reserved
