...
class AppearanceConcealedPosition(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_concealed = EnumValue(0, "Not Concealed")
    prepared_concealed_position = EnumValue(1, "Prepared Concealed Position")
    default = not_concealed
