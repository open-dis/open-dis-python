...
class AppearanceObjectGeneralPredistributed(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    object_created_during_the_exercise = EnumValue(0, "Object Created During the Exercise")
    object_predistributed_prior_to_exercise_start = EnumValue(1, "Object Predistributed Prior to Exercise Start")
    default = object_created_during_the_exercise
