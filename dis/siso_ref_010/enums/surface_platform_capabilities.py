...
class SurfacePlatformCapabilitiesBitField(ctypes.Structure):
    _fields_ = [
...
class SurfacePlatformCapabilities(ctypes.Union):
    _fields_ = [
        ("capabilities", SurfacePlatformCapabilitiesBitField),
        ("asbyte", UInt8)
    ]
