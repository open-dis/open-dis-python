...
class LifeFormHumanSpecificEquipmentClass(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    signal_smoke = EnumValue(1, "Signal Smoke")
    flash_light = EnumValue(2, "Flash Light")
    signal_mirror = EnumValue(3, "Signal Mirror")
    ir_strobe = EnumValue(4, "IR Strobe")
    ir_illuminator = EnumValue(5, "IR Illuminator")
    spotlight = EnumValue(6, "Spotlight")
    default = signal_smoke
