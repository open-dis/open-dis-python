...
class SeparationVPPreEntityIndicator(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    entity_id_existed_prior_to_separation_without_entity_state_pdu = EnumValue(1, "Entity ID Existed Prior to Separation without Entity State PDU")
    entity_id_existed_prior_to_separation_with_entity_state_pdu_issued = EnumValue(2, "Entity ID Existed Prior to Separation with Entity State PDU Issued")
    entity_initially_created_at_separation_event = EnumValue(3, "Entity Initially Created at Separation Event")
