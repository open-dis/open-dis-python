...
class Mode5MessageFormatsStatus(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    capability = EnumValue(0, "Capability")
    active_interrogation = EnumValue(1, "Active Interrogation")
    default = capability
