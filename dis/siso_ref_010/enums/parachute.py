...
class Parachute(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    none = EnumValue(0, "None")
    deployed = EnumValue(1, "Deployed")
    collapsed = EnumValue(2, "Collapsed")
    malfunction_streamer = EnumValue(3, "Malfunction/Streamer")
    default = none
