...
class AttachedParts(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    nothing_empty = EnumValue(0, "Nothing, Empty")
    m16a42_rifle = EnumValue(896, "M16A42 rifle")
    m249_saw = EnumValue(897, "M249 SAW")
    m60_machine_gun = EnumValue(898, "M60 Machine gun")
    m203_grenade_launcher = EnumValue(899, "M203 Grenade Launcher")
    m136_at4 = EnumValue(900, "M136 AT4")
    m47_dragon = EnumValue(901, "M47 Dragon")
    aaws_m_javelin = EnumValue(902, "AAWS-M Javelin")
    m18a1_claymore_mine = EnumValue(903, "M18A1 Claymore Mine")
    mk19_grenade_launcher = EnumValue(904, "MK19 Grenade Launcher")
    m2_machine_gun = EnumValue(905, "M2 Machine Gun")
    default = nothing_empty
