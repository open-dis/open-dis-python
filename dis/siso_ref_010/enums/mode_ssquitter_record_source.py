...
class ModeSSquitterRecordSource(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    layer_4_iff_data_records = EnumValue(0, "Layer 4 IFF Data Records")
    layer_5_gicb_iff_data_records = EnumValue(1, "Layer 5 GICB IFF Data Records")
    default = layer_4_iff_data_records
