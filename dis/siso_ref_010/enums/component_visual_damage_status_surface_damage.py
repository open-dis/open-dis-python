...
class ComponentVisualDamageStatusSurfaceDamage(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    normal_appearance = EnumValue(0, "Normal Appearance")
    light_charring = EnumValue(1, "Light Charring")
    heavy_charring = EnumValue(2, "Heavy Charring")
    one_or_more_holes_burned_completely_through_surface = EnumValue(3, "One or More Holes Burned Completely through Surface")
