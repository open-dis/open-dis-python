...
class AppearanceDamage(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_damage = EnumValue(0, "No Damage")
    slight_damage = EnumValue(1, "Slight Damage")
    moderate_damage = EnumValue(2, "Moderate Damage")
    destroyed = EnumValue(3, "Destroyed")
    default = no_damage
