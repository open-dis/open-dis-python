...
class SubcategoriesforSubsurfaceCategory203Crustacean(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    shrimp = EnumValue(1, "Shrimp")
    snapping_shrimp = EnumValue(2, "Snapping Shrimp")
    crayfish = EnumValue(10, "Crayfish")
    lobster = EnumValue(20, "Lobster")
    crab = EnumValue(30, "Crab")
    default = shrimp
