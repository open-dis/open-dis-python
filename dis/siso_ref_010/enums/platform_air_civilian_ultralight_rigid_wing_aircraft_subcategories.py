...
class PlatformAirCivilianUltralightRigidWingAircraftSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    weight_shift_control = EnumValue(1, "Weight-shift control")
    control_surface_elevator_rudder_aileron_control = EnumValue(2, "Control surface (elevator, rudder, aileron) control")
    default = weight_shift_control
