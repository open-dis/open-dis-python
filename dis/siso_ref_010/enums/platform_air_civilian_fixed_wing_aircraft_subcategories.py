...
class PlatformAirCivilianFixedWingAircraftSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    single_piston_engine = EnumValue(11, "Single Piston Engine")
    twin_piston_engine = EnumValue(12, "Twin Piston Engine")
    single_engine_turboprop = EnumValue(21, "Single Engine Turboprop")
    twin_engine_turboprop = EnumValue(22, "Twin Engine Turboprop")
    four_engine_turboprop = EnumValue(24, "Four Engine Turboprop")
    twin_jet = EnumValue(32, "Twin Jet")
    tri_jet = EnumValue(33, "Tri Jet")
    four_engine_jet = EnumValue(34, "Four Engine Jet")
    default = single_piston_engine
