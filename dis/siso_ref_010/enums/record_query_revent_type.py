...
class RecordQueryREventType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    periodic = EnumValue(0, "Periodic")
    internal_entity_state_data = EnumValue(1, "Internal Entity State Data")
    default = periodic
