...
class DEFirePulseShape(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    square_wave = EnumValue(1, "Square Wave")
    continuous_wave = EnumValue(2, "Continuous Wave")
    gaussian = EnumValue(3, "Gaussian")
    default = other
