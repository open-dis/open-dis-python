...
class LifeFormHumanSpecificAntiMaterielRifles(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    _127mm_aw50 = EnumValue(10, "12.7mm AW50")
    _127mm_aw50f = EnumValue(11, "12.7mm AW50F")
    _127mm_tasko_7et3 = EnumValue(12, "12.7mm TASKO 7ET3")
    default = other
