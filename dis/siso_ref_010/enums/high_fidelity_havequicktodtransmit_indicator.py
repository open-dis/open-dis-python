...
class HighFidelityHAVEQUICKTODTransmitIndicator(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_tod_is_being_transmitted = EnumValue(0, "No TOD Is Being Transmitted")
    tod_transmission_in_progress = EnumValue(1, "TOD Transmission in Progress")
    default = no_tod_is_being_transmitted
