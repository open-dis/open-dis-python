...
class PlatformSurfaceFishingVesselSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    small_fishing_vessel_up_to_26ft_79m = EnumValue(1, "Small Fishing Vessel (up to 26ft/7.9m)")
    medium_fishing_vessel_up_to_65ft_198m = EnumValue(2, "Medium Fishing Vessel (up to 65ft/19.8m)")
    large_fishing_vessel_greater_than_65ft_198m = EnumValue(3, "Large Fishing Vessel (greater than 65ft/19.8m)")
    fish_processing_vessel = EnumValue(4, "Fish Processing Vessel")
    masted_fishing_vessel = EnumValue(5, "Masted Fishing Vessel")
    default = small_fishing_vessel_up_to_26ft_79m
