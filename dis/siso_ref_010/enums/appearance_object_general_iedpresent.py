...
class AppearanceObjectGeneralIEDPresent(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    none = EnumValue(0, "None")
    visible = EnumValue(1, "Visible")
    partially_hidden = EnumValue(2, "Partially Hidden")
    completely_hidden = EnumValue(3, "Completely Hidden")
    default = none
