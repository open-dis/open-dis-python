...
class PlatformSubsurfaceCivilianSemiSubmersiblesSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    narco_submarine = EnumValue(1, "Narco-Submarine")
    default = narco_submarine
