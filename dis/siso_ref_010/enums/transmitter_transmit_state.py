...
class TransmitterTransmitState(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    off = EnumValue(0, "Off")
    on_but_not_transmitting = EnumValue(1, "On but not transmitting")
    on_and_transmitting = EnumValue(2, "On and transmitting")
    default = off
