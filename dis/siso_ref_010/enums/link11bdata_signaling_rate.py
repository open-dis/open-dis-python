...
class Link11BDataSignalingRate(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    not_used = EnumValue(1, "Not Used")
    not_used_2 = EnumValue(2, "Not Used")
    _1200_bps = EnumValue(3, "1200 bps")
    _2400_bps = EnumValue(4, "2400 bps")
    _600_bps = EnumValue(5, "600 bps")
