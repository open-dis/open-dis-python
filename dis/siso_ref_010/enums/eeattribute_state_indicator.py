...
class EEAttributeStateIndicator(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    heartbeat_update = EnumValue(0, "Heartbeat Update")
    changed_data = EnumValue(1, "Changed Data")
    has_ceased = EnumValue(2, "Has Ceased")
    default = heartbeat_update
