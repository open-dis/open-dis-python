...
class TransmissionIndicator(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    original_interrogation = EnumValue(1, "Original Interrogation")
    interrogation_reply = EnumValue(2, "Interrogation Reply")
    squitter_transmission = EnumValue(3, "Squitter Transmission")
