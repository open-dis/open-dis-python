...
class ExpendableAirCategory(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    chaff = EnumValue(1, "Chaff")
    flare = EnumValue(2, "Flare")
    combined_chaff_and_flare = EnumValue(3, "Combined Chaff and Flare")
    active_emitter = EnumValue(4, "Active Emitter")
    passive_decoy = EnumValue(5, "Passive Decoy")
    winged_decoy = EnumValue(6, "Winged Decoy")
    signal_illumination_flare = EnumValue(7, "Signal/Illumination Flare")
    smoke_generator = EnumValue(8, "Smoke Generator")
    combined_flare_and_smoke_generator = EnumValue(12, "Combined Flare and Smoke Generator")
    sar_night_light_srnl = EnumValue(13, "SAR Night Light (SRNL)")
    sar_buoy = EnumValue(14, "SAR Buoy")
    default = other
