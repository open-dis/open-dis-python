...
class AggregateStateAggregateState(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    aggregated = EnumValue(1, "Aggregated")
    disaggregated = EnumValue(2, "Disaggregated")
    fully_disaggregated = EnumValue(3, "Fully disaggregated")
    pseudo_disaggregated = EnumValue(4, "Pseudo-disaggregated")
    partially_disaggregated = EnumValue(5, "Partially-disaggregated")
    default = other
