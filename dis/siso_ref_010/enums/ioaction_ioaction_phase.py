...
class IOActionIOActionPhase(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    start_attack_profile = EnumValue(1, "Start Attack Profile")
    end_attack_profile = EnumValue(2, "End Attack Profile")
    continue_attack_profile_with_changes = EnumValue(3, "Continue Attack Profile with Changes")
    start_attack_effects = EnumValue(4, "Start Attack Effects")
    end_attacked_effects = EnumValue(5, "End Attacked Effects")
    continue_attack_effects_with_changes = EnumValue(6, "Continue Attack Effects with Changes")
