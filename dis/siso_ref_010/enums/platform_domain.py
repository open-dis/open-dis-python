...
class PlatformDomain(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    land = EnumValue(1, "Land")
    air = EnumValue(2, "Air")
    surface = EnumValue(3, "Surface")
    subsurface = EnumValue(4, "Subsurface")
    space = EnumValue(5, "Space")
    default = other
