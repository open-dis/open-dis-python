...
class Link1111BModeofOperation(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    net_sync = EnumValue(1, "Net Sync")
    net_test = EnumValue(2, "Net Test")
    roll_call = EnumValue(3, "Roll Call")
