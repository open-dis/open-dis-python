...
class LifeFormHumanSpecificPersonalElectronicsClass(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    cell_phone = EnumValue(1, "Cell Phone")
    radio_telephone_pack = EnumValue(2, "Radio/Telephone Pack")
    uav_uas_remote_controller = EnumValue(3, "UAV/UAS Remote Controller")
    default = cell_phone
