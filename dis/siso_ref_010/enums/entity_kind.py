...
class EntityKind(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    platform = EnumValue(1, "Platform")
    munition = EnumValue(2, "Munition")
    life_form = EnumValue(3, "Life form")
    environmental = EnumValue(4, "Environmental")
    cultural_feature = EnumValue(5, "Cultural feature")
    supply = EnumValue(6, "Supply")
    radio = EnumValue(7, "Radio")
    expendable = EnumValue(8, "Expendable")
    sensor_emitter = EnumValue(9, "Sensor/Emitter")
    default = other
