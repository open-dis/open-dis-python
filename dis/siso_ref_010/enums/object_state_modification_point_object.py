...
class ObjectStateModificationPointObjectBitField(ctypes.Structure):
    _fields_ = [
        # (bit position 0, boolean) Describes whether the point object location has been modified since the last update number,  use {@link UInt8} values for this field
        ("_isLocationModified", UByte, 1),

        # (bit position 1, boolean) Describes whether the point object orientation has been modified since the last update number,  use {@link UInt8} values for this field
        ("_isOrientationModified", UByte, 1)
    ]

class ObjectStateModificationPointObject(ctypes.Union):
    _fields_ = [
        ("capabilities", ObjectStateModificationPointObjectBitField),
        ("asbyte", UInt8)
    ]
