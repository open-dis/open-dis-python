...
class AppearanceObjectSpecificChemicalType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    hydrochloric = EnumValue(1, "Hydrochloric")
    white_phosphorous = EnumValue(2, "White Phosphorous")
    red_phosphorous = EnumValue(3, "Red Phosphorous")
    default = other
