...
class Mode5LocationErrors(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_location_errors = EnumValue(0, "No Location Errors")
    iff_data_record_present = EnumValue(1, "IFF Data Record Present")
    default = no_location_errors
