...
class IntercomControlRecordType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    specific_destination_record = EnumValue(1, "Specific Destination record")
    group_destination_record = EnumValue(2, "Group Destination record")
    group_assignment_record = EnumValue(3, "Group Assignment record")
    default = specific_destination_record
