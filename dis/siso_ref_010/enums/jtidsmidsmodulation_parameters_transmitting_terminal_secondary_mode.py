...
class JTIDSMIDSModulationParametersTransmittingTerminalSecondaryMode(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    none = EnumValue(0, "None")
    net_position_reference = EnumValue(1, "Net Position Reference")
    primary_navigation_controller = EnumValue(2, "Primary Navigation Controller")
    secondary_navigation_controller = EnumValue(3, "Secondary Navigation Controller")
    default = none
