...
class CCTTSINCGARSStartofMessage(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_start_of_message = EnumValue(0, "Not start of message")
    start_of_message = EnumValue(1, "Start of Message")
    default = not_start_of_message
