...
class DISProtocolVersion(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    dis_pdu_version_10_may_92 = EnumValue(1, "DIS PDU version 1.0 (May 92)")
    ieee_1278_1993 = EnumValue(2, "IEEE 1278-1993")
    dis_applications_version_20_third_draft_28_may_1993 = EnumValue(3, "DIS Applications Version 2.0 - Third Draft (28 May 1993)")
    dis_application_protocols_version_20_fourth_draft_revised_16_march_1994 = EnumValue(4, "DIS Application Protocols Version 2.0 - Fourth Draft (Revised) (16 March 1994)")
    ieee_12781_1995 = EnumValue(5, "IEEE 1278.1-1995")
    ieee_12781a_1998 = EnumValue(6, "IEEE 1278.1A-1998")
    ieee_12781_2012 = EnumValue(7, "IEEE 1278.1-2012")
    default = other
