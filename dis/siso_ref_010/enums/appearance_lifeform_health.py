...
class AppearanceLifeformHealth(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_injury = EnumValue(0, "No Injury")
    slight_injury = EnumValue(1, "Slight Injury")
    moderate_injury = EnumValue(2, "Moderate Injury")
    fatal_injury = EnumValue(3, "Fatal Injury")
    default = no_injury
