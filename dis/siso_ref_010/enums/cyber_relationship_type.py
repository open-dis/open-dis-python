...
class CyberRelationshipType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    administers = EnumValue(1, "Administers")
    administered_by = EnumValue(2, "Administered By")
    component_of = EnumValue(3, "Component Of")
    has_component = EnumValue(4, "Has Component")
    contained_in = EnumValue(5, "Contained In")
    contains = EnumValue(6, "Contains")
    provided_by = EnumValue(7, "Provided By")
    provides = EnumValue(8, "Provides")
    resides_on = EnumValue(9, "Resides On")
    has_resident = EnumValue(10, "Has Resident")
    default = administers
