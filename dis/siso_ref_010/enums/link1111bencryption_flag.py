...
class Link1111BEncryptionFlag(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_encryption_used = EnumValue(0, "No Encryption Used")
    encryption_used = EnumValue(1, "Encryption Used")
    default = no_encryption_used
