...
class IFFAlternateMode4ChallengeReply(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    valid = EnumValue(1, "Valid")
    invalid = EnumValue(2, "Invalid")
    no_response = EnumValue(3, "No response")
    unable_to_verify = EnumValue(4, "Unable to Verify")
