...
class AppearanceLifeFormPosture(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_specified = EnumValue(0, "Not Specified")
    upright_standing_still = EnumValue(1, "Upright, Standing Still")
    upright_walking = EnumValue(2, "Upright, Walking")
    upright_running = EnumValue(3, "Upright, Running")
    kneeling = EnumValue(4, "Kneeling")
    prone = EnumValue(5, "Prone")
    crawling = EnumValue(6, "Crawling")
    swimming = EnumValue(7, "Swimming")
    parachuting = EnumValue(8, "Parachuting")
    jumping = EnumValue(9, "Jumping")
    sitting = EnumValue(10, "Sitting")
    squatting = EnumValue(11, "Squatting")
    crouching = EnumValue(12, "Crouching")
    wading = EnumValue(13, "Wading")
    surrender = EnumValue(14, "Surrender")
    detained = EnumValue(15, "Detained")
