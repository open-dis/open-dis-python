...
class PlatformLandUtilityEmergencyCarSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    ambulance_car = EnumValue(1, "Ambulance Car")
    police_car = EnumValue(2, "Police Car")
    police_chief = EnumValue(3, "Police Chief")
    hearse = EnumValue(4, "Hearse")
    taxi = EnumValue(5, "Taxi")
    default = other
