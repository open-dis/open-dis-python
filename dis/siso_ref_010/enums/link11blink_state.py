...
class Link11BLinkState(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    inactive = EnumValue(1, "Inactive")
    ready = EnumValue(2, "Ready")
    active = EnumValue(3, "Active")
    operational = EnumValue(4, "Operational")
