...
class AppearanceEnvironmentalDensity(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    clear = EnumValue(0, "Clear")
    hazy = EnumValue(1, "Hazy")
    dense = EnumValue(2, "Dense")
    very_dense = EnumValue(3, "Very Dense")
    opaque = EnumValue(4, "Opaque")
    default = clear
