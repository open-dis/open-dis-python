...
class IFFLayerSpecificInformation(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_layer_specific_information_is_present = EnumValue(0, "No Layer-Specific Information Is Present")
    default = no_layer_specific_information_is_present
