...
class EntityDamageStatusComponentIdentification(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    entity_center_no_specific_component = EnumValue(0, "Entity Center (No Specific Component)")
    entity_structure = EnumValue(1, "Entity Structure")
    control_system = EnumValue(2, "Control System")
    control_surface = EnumValue(3, "Control Surface")
    engine_propulsion_system = EnumValue(4, "Engine / Propulsion System")
    crew_member = EnumValue(5, "Crew Member")
    fuse = EnumValue(6, "Fuse")
    acquisition_sensor = EnumValue(7, "Acquisition Sensor")
    tracking_sensor = EnumValue(8, "Tracking Sensor")
    fuel_tank_solid_rocket_motor = EnumValue(9, "Fuel Tank / Solid Rocket Motor")
    default = entity_center_no_specific_component
