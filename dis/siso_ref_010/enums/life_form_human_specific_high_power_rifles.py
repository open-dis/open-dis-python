...
class LifeFormHumanSpecificHighPowerRifles(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    _762mm_m14 = EnumValue(10, "7.62mm M14")
    _762mm_remington_700 = EnumValue(11, "7.62mm Remington 700")
    _762mm_sig_sauer_ssg_2000 = EnumValue(12, "7.62mm SIG-Sauer SSG-2000")
    _762mm_stoner_sr_25 = EnumValue(13, "7.62mm Stoner SR-25")
    _762mm_mosin_nagant_model_1891_30 = EnumValue(14, "7.62mm Mosin-Nagant Model 1891/30")
    _762mm_hk417 = EnumValue(15, "7.62mm HK417")
    _762mm_hk417_16_recce = EnumValue(16, "7.62mm HK417 16' Recce")
    _765mm_bar_m1918 = EnumValue(50, "7.65mm BAR M1918")
    _765mm_m1_garand = EnumValue(51, "7.65mm M1 Garand")
    default = other
