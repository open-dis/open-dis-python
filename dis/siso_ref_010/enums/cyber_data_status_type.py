...
class CyberDataStatusType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    intact = EnumValue(1, "Intact")
    compromised = EnumValue(2, "Compromised")
    corrupted = EnumValue(3, "Corrupted")
    manipulated = EnumValue(4, "Manipulated")
    non_decryptable = EnumValue(5, "Non Decryptable")
    erased = EnumValue(6, "Erased")
    default = intact
