...
class LifeFormHumanSpecificLasersClass(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    generic_laser_designator = EnumValue(1, "Generic Laser Designator")
    generic_laser_pointer = EnumValue(2, "Generic Laser Pointer")
    default = generic_laser_designator
