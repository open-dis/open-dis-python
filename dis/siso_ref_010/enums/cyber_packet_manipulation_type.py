...
class CyberPacketManipulationType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    duplication = EnumValue(1, "Duplication")
    corruption = EnumValue(2, "Corruption")
    reordering = EnumValue(3, "Reordering")
    dropped = EnumValue(4, "Dropped")
    default = duplication
