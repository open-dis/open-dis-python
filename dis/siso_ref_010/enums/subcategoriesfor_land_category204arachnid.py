...
class SubcategoriesforLandCategory204Arachnid(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    spider = EnumValue(1, "Spider")
    tick = EnumValue(20, "Tick")
    scorpion = EnumValue(30, "Scorpion")
    harvestmen = EnumValue(40, "Harvestmen")
    mite = EnumValue(50, "Mite")
    default = spider
