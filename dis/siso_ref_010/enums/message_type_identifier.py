...
class MessageTypeIdentifier(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    jtids_header_messages = EnumValue(0, "JTIDS Header/Messages")
    rtt_a_b = EnumValue(1, "RTT A/B")
    rtt_reply = EnumValue(2, "RTT Reply")
    jtids_voice_cvsd = EnumValue(3, "JTIDS Voice CVSD")
    jtids_voice_lpc10 = EnumValue(4, "JTIDS Voice LPC10")
    jtids_voice_lpc12 = EnumValue(5, "JTIDS Voice LPC12")
    jtids_let = EnumValue(6, "JTIDS LET")
    vmf = EnumValue(7, "VMF")
    default = jtids_header_messages
