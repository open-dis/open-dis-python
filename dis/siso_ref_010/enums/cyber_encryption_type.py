...
class CyberEncryptionType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_encrypted = EnumValue(1, "Not Encrypted")
    des = EnumValue(2, "DES")
    triple_des = EnumValue(3, "Triple DES")
    rsa = EnumValue(4, "RSA")
    aes = EnumValue(5, "AES")
    twofish = EnumValue(6, "Twofish")
