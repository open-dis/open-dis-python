...
class ModeSSquitterType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_capable = EnumValue(0, "Not Capable")
    acquisition = EnumValue(1, "Acquisition")
    extended = EnumValue(2, "Extended")
    Short = EnumValue(3, "Short")
    default = not_capable
