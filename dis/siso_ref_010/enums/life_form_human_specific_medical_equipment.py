...
class LifeFormHumanSpecificMedicalEquipment(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    field_medical_kit = EnumValue(1, "Field Medical Kit")
    surgical_kit = EnumValue(2, "Surgical Kit")
    first_aid_kit = EnumValue(3, "First Aid Kit")
    default = other
