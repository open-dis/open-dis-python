...
class SurveillanceStatus(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_information = EnumValue(0, "No Information")
    emergency_loss_of_communications = EnumValue(1, "Emergency/Loss of Communications")
    spi = EnumValue(2, "SPI")
    atcrbs_code_change = EnumValue(3, "ATCRBS Code Change")
