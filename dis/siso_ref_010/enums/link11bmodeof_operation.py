...
class Link11BModeofOperation(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    full_transmission_of_data = EnumValue(1, "Full Transmission of Data")
    limited_transmission_of_data = EnumValue(2, "Limited Transmission of Data")
    receive_only = EnumValue(3, "Receive only")
