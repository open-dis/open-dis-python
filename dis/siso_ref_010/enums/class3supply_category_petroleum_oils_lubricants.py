...
class Class3SupplyCategoryPetroleumOilsLubricants(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(1, "Other")
    a_pol_for_air_vehicles = EnumValue(2, "A - POL for Air Vehicles")
    w_pol_for_land_vehicles = EnumValue(3, "W - POL for Land Vehicles")
    p_packaged_pol = EnumValue(4, "P - Packaged POL")
    default = other
