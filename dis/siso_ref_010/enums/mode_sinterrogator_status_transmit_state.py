...
class ModeSInterrogatorStatusTransmitState(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    roll_call = EnumValue(1, "Roll-Call")
    all_call = EnumValue(2, "All Call")
    lockout_override = EnumValue(3, "Lockout Override")
    temporary_lockout = EnumValue(4, "Temporary Lockout")
    intermittent_lockout = EnumValue(5, "Intermittent Lockout")
