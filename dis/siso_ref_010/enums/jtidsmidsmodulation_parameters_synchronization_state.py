...
class JTIDSMIDSModulationParametersSynchronizationState(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    initial_net_entry = EnumValue(1, "Initial Net Entry")
    coarse_synchronization = EnumValue(2, "Coarse Synchronization")
    fine_synchronization = EnumValue(3, "Fine Synchronization")
    synchronization_maintenance = EnumValue(4, "Synchronization Maintenance")
