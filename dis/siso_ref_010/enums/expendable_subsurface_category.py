...
class ExpendableSubsurfaceCategory(ExtensibleEnum, metaclass=EnumMeta):
    ...
    signal = EnumValue(7, "Signal")
    noise_maker_decoy = EnumValue(9, "Noise-Maker Decoy")
    bubble_maker_decoy = EnumValue(10, "Bubble-Maker Decoy")
    multi_mode_decoy = EnumValue(11, "Multi-Mode Decoy")
    default = other
