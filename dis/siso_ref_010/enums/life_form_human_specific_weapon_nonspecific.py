...
class LifeFormHumanSpecificWeaponNonspecific(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    knife = EnumValue(10, "Knife")
    machete = EnumValue(50, "Machete")
    explosive_vest = EnumValue(100, "Explosive Vest")
    m18a1_claymore = EnumValue(150, "M18A1 Claymore")
    mine_clearing_line_charge = EnumValue(160, "Mine Clearing Line Charge")
    default = other
