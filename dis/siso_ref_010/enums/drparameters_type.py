...
class DRParametersType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    none = EnumValue(0, "None")
    local_euler_angles_yaw_pitch_roll = EnumValue(1, "Local Euler Angles (Yaw, Pitch, Roll)")
    world_orientation_quaternion = EnumValue(2, "World Orientation Quaternion")
    default = none
