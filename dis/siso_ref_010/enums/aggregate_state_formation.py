...
class AggregateStateFormation(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    assembly = EnumValue(1, "Assembly")
    vee = EnumValue(2, "Vee")
    wedge = EnumValue(3, "Wedge")
    line = EnumValue(4, "Line")
    column = EnumValue(5, "Column")
    default = other
