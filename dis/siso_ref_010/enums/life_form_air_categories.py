...
class LifeFormAirCategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    # XREF UID 110 - CLASS SubcategoriesforAirCategory200Bird 
    bird = EnumValue(200, "Bird")
    # XREF UID 111 - CLASS SubcategoriesforAirCategory201Insect 
    insect = EnumValue(201, "Insect")
    # XREF UID 112 - CLASS SubcategoriesforAirCategory202Mammal 
    mammal = EnumValue(202, "Mammal")
    default = bird
