...
class AggregateStateSpecific(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_headquarters = EnumValue(0, "No headquarters")
    yes_aggregate_unit_contains_a_headquarters = EnumValue(1, "Yes aggregate unit contains a headquarters")
    default = no_headquarters
