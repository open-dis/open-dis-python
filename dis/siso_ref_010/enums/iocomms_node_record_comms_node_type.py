...
class IOCommsNodeRecordCommsNodeType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    sender_node_id = EnumValue(1, "Sender Node ID")
    receiver_node_id = EnumValue(2, "Receiver Node ID")
    sender_receiver_node_id = EnumValue(3, "Sender/Receiver Node ID")
