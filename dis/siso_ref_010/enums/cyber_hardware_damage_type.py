...
class CyberHardwareDamageType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    boot_loop = EnumValue(1, "Boot Loop")
    physical_destruction = EnumValue(2, "Physical Destruction")
    hard_drive_erased = EnumValue(3, "Hard Drive Erased")
    default = boot_loop
