...
class MinefieldSensorTypesRADAR(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    generic = EnumValue(0, "Generic")
    generic_gpr = EnumValue(1, "Generic GPR")
    gstamids_i = EnumValue(2, "GSTAMIDS I")
    gstamids_ii = EnumValue(3, "GSTAMIDS II")
    hstamids_i = EnumValue(4, "HSTAMIDS I")
    hstamids_ii = EnumValue(5, "HSTAMIDS II")
    default = generic
