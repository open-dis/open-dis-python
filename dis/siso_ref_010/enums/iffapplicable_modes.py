...
class IFFApplicableModes(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_applicable_modes_data = EnumValue(0, "No Applicable Modes Data")
    all_modes = EnumValue(1, "All Modes")
    default = no_applicable_modes_data
