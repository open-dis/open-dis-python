...
class LifeFormHumanSpecificAnimalCompanions(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    military_working_dog = EnumValue(1, "Military Working Dog")
    military_working_dog_mine_detection = EnumValue(2, "Military Working Dog, Mine Detection")
    military_working_dog_drug_detection = EnumValue(3, "Military Working Dog, Drug Detection")
    default = other
