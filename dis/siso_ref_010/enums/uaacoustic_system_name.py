...
class UAAcousticSystemName(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    an_bqq_5 = EnumValue(1, "AN/BQQ-5")
    an_ssq_62 = EnumValue(2, "AN/SSQ-62")
    an_sqs_23 = EnumValue(3, "AN/SQS-23")
    an_sqs_26 = EnumValue(4, "AN/SQS-26")
    an_sqs_53 = EnumValue(5, "AN/SQS-53")
    alfs = EnumValue(6, "ALFS")
    lfa = EnumValue(7, "LFA")
    an_aqs_901 = EnumValue(8, "AN/AQS-901")
    an_aqs_902 = EnumValue(9, "AN/AQS-902")
    default = other
