...
class ServiceRequestServiceTypeRequested(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    resupply = EnumValue(1, "Resupply")
    repair = EnumValue(2, "Repair")
    aerial_refueling_high_fidelity = EnumValue(3, "Aerial Refueling High Fidelity")
    aerial_refueling_low_fidelity = EnumValue(4, "Aerial Refueling Low Fidelity")
    default = other
