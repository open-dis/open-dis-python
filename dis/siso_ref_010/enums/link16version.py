...
class Link16Version(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    mil_std_6016c = EnumValue(1, "MIL-STD-6016C")
    mil_std_6016d = EnumValue(2, "MIL-STD-6016D")
    mil_std_6016e = EnumValue(3, "MIL-STD-6016E")
    mil_std_6016f = EnumValue(4, "MIL-STD-6016F")
    mil_std_6016f_c1 = EnumValue(5, "MIL-STD-6016F C1")
    stanag_5516_ed_3 = EnumValue(103, "STANAG 5516 Ed 3")
    stanag_5516_ed_4 = EnumValue(104, "STANAG 5516 Ed 4")
    stanag_5516_ed_5 = EnumValue(105, "STANAG 5516 Ed 5")
    stanag_5516_ed_6 = EnumValue(106, "STANAG 5516 Ed 6")
    stanag_5516_ed_8 = EnumValue(108, "STANAG 5516 Ed 8")
