...
class EntityAssociationGroupMemberType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_part_of_a_group = EnumValue(0, "Not Part of a Group")
    group_leader = EnumValue(1, "Group Leader")
    group_member = EnumValue(2, "Group Member")
    formation_leader = EnumValue(3, "Formation Leader")
    formation_member = EnumValue(4, "Formation Member")
    convoy_leader = EnumValue(5, "Convoy Leader")
    convoy_member = EnumValue(6, "Convoy Member")
    default = not_part_of_a_group
