...
class TCASIIIType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    tcas_i_or_no_statement = EnumValue(0, "TCAS I (or No Statement)")
    tcas_ii = EnumValue(1, "TCAS II")
    default = tcas_i_or_no_statement
