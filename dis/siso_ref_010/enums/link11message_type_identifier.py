...
class Link11MessageTypeIdentifier(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    net_test = EnumValue(1, "Net Test")
    roll_call = EnumValue(2, "Roll Call")
    picket_reply = EnumValue(3, "Picket Reply")
    short_broadcast = EnumValue(4, "Short Broadcast")
    broadcast = EnumValue(5, "Broadcast")
    net_sync = EnumValue(6, "Net Sync")
