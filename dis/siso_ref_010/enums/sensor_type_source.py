...
class SensorTypeSource(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other_active_sensors = EnumValue(0, "Other Active Sensors")
    electromagnetic = EnumValue(1, "Electromagnetic")
    passive_sensors = EnumValue(2, "Passive Sensors")
    minefield_sensors = EnumValue(3, "Minefield Sensors")
    underwater_acoustics = EnumValue(4, "Underwater Acoustics")
    lasers = EnumValue(5, "Lasers")
    default = other_active_sensors
