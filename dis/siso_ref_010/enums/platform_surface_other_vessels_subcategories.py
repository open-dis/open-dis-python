...
class PlatformSurfaceOtherVesselsSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    go_fast_boat = EnumValue(1, "Go-Fast Boat")
    research_vessel = EnumValue(2, "Research Vessel")
    hydrofoil_vessel = EnumValue(3, "Hydrofoil Vessel")
    cable_layer_vessel = EnumValue(4, "Cable Layer Vessel")
    dredger_vessel = EnumValue(5, "Dredger Vessel")
    junk_dhow_vessel = EnumValue(6, "Junk/Dhow Vessel")
    catamaran = EnumValue(7, "Catamaran")
    pontoon = EnumValue(8, "Pontoon")
    personal_water_craft = EnumValue(9, "Personal Water Craft")
    refugee_raft = EnumValue(10, "Refugee Raft")
    lightship = EnumValue(11, "Lightship")
    law_enforcement_vessel = EnumValue(12, "Law Enforcement Vessel")
    pilot_vessel = EnumValue(13, "Pilot Vessel")
    default = go_fast_boat
