...
class SubcategoriesforLandCategory206Marsupial(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    brown_four_eyed_opossum = EnumValue(1, "Brown Four-Eyed Opossum")
    bushy_tailed_opossum = EnumValue(2, "Bushy-Tailed Opossum")
    tates_shrew_opossum = EnumValue(90, "Tate's Shrew Opossum")
    greater_bilby = EnumValue(100, "Greater Bilby")
    tasmanian_devil = EnumValue(110, "Tasmanian Devil")
    brush_tailed_rock_wallaby = EnumValue(150, "Brush-Tailed Rock-Wallaby")
    eastern_wallaroo = EnumValue(160, "Eastern Wallaroo")
    red_kangaroo = EnumValue(170, "Red Kangaroo")
    queensland_koala = EnumValue(200, "Queensland Koala")
    southern_hairy_nosed_wombat = EnumValue(205, "Southern Hairy-Nosed Wombat")
    brushtail_possum = EnumValue(210, "Brushtail Possum")
    sugar_glider = EnumValue(211, "Sugar Glider")
    default = brown_four_eyed_opossum
