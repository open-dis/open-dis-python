...
class AppearanceNVGMode(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    overt_lighting = EnumValue(0, "Overt Lighting")
    covert_lighting_night_vision_goggles = EnumValue(1, "Covert Lighting (Night Vision Goggles)")
    default = overt_lighting
