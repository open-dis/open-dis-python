...
class IFFSystemMode(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    off = EnumValue(1, "Off")
    standby = EnumValue(2, "Standby")
    normal = EnumValue(3, "Normal")
    emergency = EnumValue(4, "Emergency")
    low_or_low_sensitivity = EnumValue(5, "Low or Low Sensitivity")
