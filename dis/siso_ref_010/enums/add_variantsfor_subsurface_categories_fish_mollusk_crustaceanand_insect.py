...
class AddVariantsforSubsurfaceCategoriesFishMolluskCrustaceanandInsect(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    black = EnumValue(1, "Black")
    green = EnumValue(2, "Green")
    spotted = EnumValue(3, "Spotted")
    red = EnumValue(4, "Red")
    brown = EnumValue(5, "Brown")
    blue = EnumValue(6, "Blue")
    silver = EnumValue(7, "Silver")
    grey = EnumValue(8, "Grey")
    default = black
