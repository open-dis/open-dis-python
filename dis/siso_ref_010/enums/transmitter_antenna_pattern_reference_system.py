...
class TransmitterAntennaPatternReferenceSystem(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    world_coordinates = EnumValue(1, "World Coordinates")
    entity_coordinates = EnumValue(2, "Entity Coordinates")
