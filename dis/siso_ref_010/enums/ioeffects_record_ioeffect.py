...
class IOEffectsRecordIOEffect(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    denial = EnumValue(1, "Denial")
    degradation = EnumValue(2, "Degradation")
    disruption = EnumValue(3, "Disruption")
    terminate_effect = EnumValue(255, "Terminate Effect")
