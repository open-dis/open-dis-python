...
class PlatformSurfacePrivateMotorboatSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    small_motorboat_up_to_26ft_79m = EnumValue(1, "Small Motorboat (up to 26ft/7.9m)")
    medium_motorboat_up_to_39ft_119m = EnumValue(2, "Medium Motorboat (up to 39ft/11.9m)")
    large_motorboat_up_to_65ft_198m = EnumValue(3, "Large Motorboat (up to 65ft/19.8m)")
    very_large_motorboat_greater_than_65ft_198m = EnumValue(4, "Very Large Motorboat (greater than 65ft/19.8m)")
    default = small_motorboat_up_to_26ft_79m
