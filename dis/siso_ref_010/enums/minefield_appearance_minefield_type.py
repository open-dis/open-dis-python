...
class MinefieldAppearanceMinefieldType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    mixed_anti_personnel_and_anti_tank_minefield = EnumValue(0, "Mixed Anti-Personnel and Anti-Tank Minefield")
    pure_anti_personnel_minefield = EnumValue(1, "Pure Anti-Personnel Minefield")
    pure_anti_tank_minefield = EnumValue(2, "Pure Anti-Tank Minefield")
    default = mixed_anti_personnel_and_anti_tank_minefield
