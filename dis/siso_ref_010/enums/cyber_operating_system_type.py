...
class CyberOperatingSystemType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    microsoft_dos = EnumValue(1, "Microsoft DOS")
    microsoft_windows = EnumValue(2, "Microsoft Windows")
    apple_mac_os = EnumValue(3, "Apple Mac OS")
    dec_vms = EnumValue(4, "DEC VMS")
    ibm_os_2 = EnumValue(5, "IBM OS_2")
    android = EnumValue(6, "Android")
    apple_ios = EnumValue(7, "Apple iOS")
    cisco_ios = EnumValue(8, "Cisco IOS")
    firmware = EnumValue(9, "Firmware")
    unix_linux = EnumValue(10, "UNIX - Linux")
    default = microsoft_dos
