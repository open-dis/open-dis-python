...
class CyberNetworkProtocolType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    internet_protocol = EnumValue(1, "Internet Protocol")
    nat = EnumValue(2, "NAT")
    icmp = EnumValue(3, "ICMP")
    arp = EnumValue(4, "ARP")
    rip = EnumValue(5, "RIP")
    ospf = EnumValue(6, "OSPF")
    ipsec = EnumValue(7, "IPsec")
    default = internet_protocol
