...
class MinefieldStateProtocolMode(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    heartbeat_mode = EnumValue(0, "Heartbeat Mode")
    qrp_mode = EnumValue(1, "QRP Mode")
    default = heartbeat_mode
