...
class TransmitterDetailPulseModulation(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    pulse = EnumValue(1, "Pulse")
    x_band_tacan_pulse = EnumValue(2, "X Band TACAN Pulse")
    y_band_tacan_pulse = EnumValue(3, "Y Band TACAN Pulse")
    default = other
