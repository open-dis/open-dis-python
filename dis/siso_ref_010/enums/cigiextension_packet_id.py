...
class CIGIExtensionPacketID(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    image_capture_request_packet_id = EnumValue(4096, "Image Capture Request packet ID")
    image_capture_response_packet_id = EnumValue(4097, "Image Capture Response packet ID")
    state_notification_request_packet_id = EnumValue(4098, "State Notification Request Packet ID")
    state_notification_response_packet_id = EnumValue(4099, "State Notification Response Packet ID")
    globalrefframedef_packet_id = EnumValue(5000, "GlobalRefFrameDef Packet ID")
    default = image_capture_request_packet_id
