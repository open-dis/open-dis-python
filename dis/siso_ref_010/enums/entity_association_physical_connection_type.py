...
class EntityAssociationPhysicalConnectionType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_specified = EnumValue(0, "Not Specified")
    attached_directly_to_surface = EnumValue(1, "Attached Directly to Surface")
    cable_wire = EnumValue(2, "Cable Wire")
    rope = EnumValue(3, "Rope")
    chain = EnumValue(4, "Chain")
    power_line = EnumValue(5, "Power Line")
    telephone_line = EnumValue(6, "Telephone Line")
    cable_line = EnumValue(7, "Cable Line")
    refueling_drogue = EnumValue(8, "Refueling Drogue")
    refueling_boom = EnumValue(9, "Refueling Boom")
    handcuffs = EnumValue(10, "Handcuffs")
    in_contact_with = EnumValue(11, "In Contact With")
    fast_rope = EnumValue(12, "Fast Rope")
