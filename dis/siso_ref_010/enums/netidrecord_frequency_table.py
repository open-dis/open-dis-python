...
class NETIDRecordFrequencyTable(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    hq_i_operations = EnumValue(0, "HQ I Operations")
    hqii_nato_europe_area_operations = EnumValue(1, "HQII - NATO/Europe Area Operations")
    hqii_non_nato_europe_area_operations = EnumValue(2, "HQII - Non-NATO/Europe Area Operations")
    saturn_operations = EnumValue(3, "SATURN Operations")
    default = hq_i_operations
