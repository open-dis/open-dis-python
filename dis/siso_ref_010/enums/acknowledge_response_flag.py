...
class AcknowledgeResponseFlag(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    able_to_comply = EnumValue(1, "Able to comply")
    unable_to_comply = EnumValue(2, "Unable to comply")
    pending_operator_action = EnumValue(3, "Pending Operator Action")
    default = other
