...
class SignalEncodingClass(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    encoded_audio = EnumValue(0, "Encoded audio")
    raw_binary_data = EnumValue(1, "Raw Binary Data")
    application_specific_data = EnumValue(2, "Application-Specific Data")
    database_index = EnumValue(3, "Database index")
    default = encoded_audio
