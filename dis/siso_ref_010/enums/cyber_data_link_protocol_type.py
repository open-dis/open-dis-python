...
class CyberDataLinkProtocolType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    ethernet = EnumValue(1, "Ethernet")
    wifi = EnumValue(2, "Wifi")
    atm = EnumValue(3, "ATM")
    localtalk = EnumValue(4, "LocalTalk")
    ppp = EnumValue(5, "PPP")
    token_ring = EnumValue(6, "Token Ring")
    vlan = EnumValue(7, "VLAN")
    bluetooth = EnumValue(8, "Bluetooth")
    _1553bus = EnumValue(9, "1553Bus")
    llc = EnumValue(10, "LLC")
    default = ethernet
