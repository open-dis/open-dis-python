...
class ArticulatedPartsTypeMetric(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_specified = EnumValue(0, "Not Specified")
    position = EnumValue(1, "Position")
    position_rate = EnumValue(2, "Position Rate")
    extension = EnumValue(3, "Extension")
    extension_rate = EnumValue(4, "Extension Rate")
    x = EnumValue(5, "X")
    x_rate = EnumValue(6, "X Rate")
    y = EnumValue(7, "Y")
    y_rate = EnumValue(8, "Y Rate")
    z = EnumValue(9, "Z")
    z_rate = EnumValue(10, "Z Rate")
    azimuth = EnumValue(11, "Azimuth")
    azimuth_rate = EnumValue(12, "Azimuth Rate")
    elevation = EnumValue(13, "Elevation")
    elevation_rate = EnumValue(14, "Elevation Rate")
    rotation = EnumValue(15, "Rotation")
    rotation_rate = EnumValue(16, "Rotation Rate")
