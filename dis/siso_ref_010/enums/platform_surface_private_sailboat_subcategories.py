...
class PlatformSurfacePrivateSailboatSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    small_sailboat_up_to_26ft_79m = EnumValue(1, "Small Sailboat (up to 26ft/7.9m)")
    medium_sailboat_up_to_39ft_119m = EnumValue(2, "Medium Sailboat (up to 39ft/11.9m)")
    large_sailboat_up_to_65ft_198m = EnumValue(3, "Large Sailboat (up to 65ft/19.8m)")
    very_large_sailboat_greater_than_65ft_198m = EnumValue(4, "Very Large Sailboat (greater than 65ft/19.8m)")
    default = small_sailboat_up_to_26ft_79m
