...
class ClothingIRSignature(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    standard_clothing = EnumValue(0, "Standard Clothing")
    camouflage_not_just_paint_scheme = EnumValue(1, "Camouflage (not just Paint Scheme)")
    thermal_blanket = EnumValue(2, "Thermal Blanket")
    other = EnumValue(3, "Other")
    default = standard_clothing
