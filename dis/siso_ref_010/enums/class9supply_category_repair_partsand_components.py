...
class Class9SupplyCategoryRepairPartsandComponents(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(1, "Other")
    a_air = EnumValue(2, "A - Air")
    b_ground_support_materiel = EnumValue(3, "B - Ground Support Materiel")
    d_admin_vehicles = EnumValue(4, "D - Admin Vehicles")
    g_electronics = EnumValue(5, "G - Electronics")
    k_tactical_vehicles = EnumValue(6, "K - Tactical Vehicles")
    l_missiles = EnumValue(7, "L - Missiles")
    m_weapons = EnumValue(8, "M - Weapons")
    n_special_weapons = EnumValue(9, "N - Special Weapons")
    x_aircraft_engines = EnumValue(10, "X - Aircraft Engines")
    default = other
