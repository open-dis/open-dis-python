...
class AppearanceCamouflageType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    desert_camouflage = EnumValue(0, "Desert Camouflage")
    winter_camouflage = EnumValue(1, "Winter Camouflage")
    forest_camouflage = EnumValue(2, "Forest Camouflage")
    other = EnumValue(3, "Other")
    default = desert_camouflage
