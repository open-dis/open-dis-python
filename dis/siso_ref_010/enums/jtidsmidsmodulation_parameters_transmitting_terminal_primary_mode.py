...
class JTIDSMIDSModulationParametersTransmittingTerminalPrimaryMode(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    ntr = EnumValue(1, "NTR")
    jtids_unit_participant = EnumValue(2, "JTIDS Unit Participant")
    default = ntr
