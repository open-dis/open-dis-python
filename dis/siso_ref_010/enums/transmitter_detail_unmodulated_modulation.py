...
class TransmitterDetailUnmodulatedModulation(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    continuous_wave_emission_of_an_unmodulated_carrier = EnumValue(1, "Continuous Wave emission of an unmodulated carrier")
    default = other
