...
class PlatformAirCivilianLighterthanAirBalloonSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    gas_filled_free = EnumValue(1, "Gas-filled, free")
    gas_filled_tethered = EnumValue(2, "Gas-filled, tethered")
    hot_air = EnumValue(3, "Hot Air")
    roziere_balloon = EnumValue(4, "Roziere Balloon")
    helikite = EnumValue(5, "Helikite")
    default = gas_filled_free
