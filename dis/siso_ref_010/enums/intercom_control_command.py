...
class IntercomControlCommand(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_command = EnumValue(0, "No Command")
    status = EnumValue(1, "Status")
    connect = EnumValue(2, "Connect")
    disconnect = EnumValue(3, "Disconnect")
    reset = EnumValue(4, "Reset")
    on = EnumValue(5, "On")
    off = EnumValue(6, "Off")
    default = no_command
