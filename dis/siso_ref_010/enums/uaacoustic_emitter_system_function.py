...
class UAAcousticEmitterSystemFunction(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    platform_search_detect_track = EnumValue(1, "Platform search/detect/track")
    navigation = EnumValue(2, "Navigation")
    mine_hunting = EnumValue(3, "Mine hunting")
    weapon_search_detect_track_detect = EnumValue(4, "Weapon search/detect/track/detect")
    default = other
