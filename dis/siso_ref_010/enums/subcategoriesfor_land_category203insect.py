...
class SubcategoriesforLandCategory203Insect(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    beetle = EnumValue(1, "Beetle")
    mantis = EnumValue(60, "Mantis")
    cockroach = EnumValue(70, "Cockroach")
    army_ant = EnumValue(80, "Army Ant")
    fire_ant = EnumValue(81, "Fire Ant")
    grasshopper = EnumValue(90, "Grasshopper")
    centipede = EnumValue(100, "Centipede")
    default = beetle
