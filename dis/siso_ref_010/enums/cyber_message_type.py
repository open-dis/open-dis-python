...
class CyberMessageType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    email = EnumValue(1, "Email")
    chat = EnumValue(2, "Chat")
    text = EnumValue(3, "Text")
    social_media = EnumValue(4, "Social Media")
    default = email
