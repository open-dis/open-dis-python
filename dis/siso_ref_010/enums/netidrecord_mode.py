...
class NETIDRecordMode(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    a_have_quick_i_or_have_quick_ii_combat = EnumValue(1, "A - HAVE QUICK I or HAVE QUICK II COMBAT")
    b_saturn_combat = EnumValue(2, "B - SATURN COMBAT")
    t_training = EnumValue(3, "T - TRAINING")
    default = a_have_quick_i_or_have_quick_ii_combat
