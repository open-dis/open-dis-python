...
class IOActionIOActionType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    io_attack_profile_data_parametrics = EnumValue(1, "IO Attack - Profile Data (Parametrics)")
    io_attack_computed_effects = EnumValue(2, "IO Attack - Computed Effects")
    intent_based_ew = EnumValue(3, "Intent-Based-EW")
    intent_based_ew_computed_effects = EnumValue(4, "Intent-Based-EW - Computed Effects")
