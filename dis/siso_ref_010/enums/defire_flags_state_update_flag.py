...
class DEFireFlagsStateUpdateFlag(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    update_due_to_heartbeat_timer = EnumValue(0, "Update Due to Heartbeat Timer")
    state_change = EnumValue(1, "State Change")
    default = update_due_to_heartbeat_timer
