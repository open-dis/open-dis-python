...
class Mode5LevelSelection(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    mode_5_level_1 = EnumValue(0, "Mode 5 Level 1")
    mode_5_level_2 = EnumValue(1, "Mode 5 Level 2")
    default = mode_5_level_1
