...
class IOActionIOWarfareType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    electronic_warfare_ew = EnumValue(1, "Electronic Warfare (EW)")
    computer_network_operations_cno = EnumValue(2, "Computer Network Operations (CNO)")
    psychological_operations_psyops = EnumValue(3, "Psychological Operations (PSYOPS)")
    military_deception_mildec = EnumValue(4, "Military Deception (MILDEC)")
    operations_security_opsec = EnumValue(5, "Operations Security (OPSEC)")
    physical_attack = EnumValue(6, "Physical Attack")
