...
class Link11SignalWaveform(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement_clew_format = EnumValue(0, "No Statement - CLEW Format")
    conventional_link_eleven_waveform_clew = EnumValue(1, "Conventional Link Eleven Waveform (CLEW)")
    single_tone_link_eleven_waveform_slew = EnumValue(2, "Single Tone Link Eleven Waveform (SLEW)")
    default = no_statement_clew_format
