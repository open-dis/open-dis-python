...
class AustralianCategoryOverlay(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    australian_army = EnumValue(11, "Australian Army")
    royal_australian_air_force_raaf = EnumValue(13, "Royal Australian Air Force (RAAF)")
    royal_australian_navy_ran = EnumValue(14, "Royal Australian Navy (RAN)")
    australian_special_operations_command_socomd = EnumValue(30, "Australian Special Operations Command (SOCOMD)")
    australian_department_of_home_affairs = EnumValue(51, "Australian Department of Home Affairs")
    australian_federal_police_afp = EnumValue(52, "Australian Federal Police (AFP)")
    default = australian_army
