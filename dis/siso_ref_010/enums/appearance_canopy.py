...
class AppearanceCanopy(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_applicable = EnumValue(0, "Not Applicable")
    single_canopy_single_troop_door_closed = EnumValue(1, "Single Canopy/Single Troop Door Closed")
    front_and_rear_canopy_left_and_right_troop_door_closed = EnumValue(2, "Front and Rear Canopy/Left and Right Troop Door Closed")
    front_canopy_left_troop_door_open = EnumValue(3, "Front Canopy/Left Troop Door Open")
    single_canopy_single_troop_door_open = EnumValue(4, "Single Canopy/Single Troop Door Open")
    rear_canopy_right_troop_door_open = EnumValue(5, "Rear Canopy/Right Troop Door Open")
    front_and_rear_canopy_left_and_right_troop_door_open = EnumValue(6, "Front and Rear Canopy/Left and Right Troop Door Open")
