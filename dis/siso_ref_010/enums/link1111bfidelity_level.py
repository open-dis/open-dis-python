...
class Link1111BFidelityLevel(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    fidelity_level_0 = EnumValue(0, "Fidelity Level 0")
    fidelity_level_1 = EnumValue(1, "Fidelity Level 1")
    fidelity_level_2 = EnumValue(2, "Fidelity Level 2")
