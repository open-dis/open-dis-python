...
class ExplosiveMaterialGroups(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    general = EnumValue(0, "General")
    liquid_aviation_missile_fuels = EnumValue(1, "Liquid - Aviation/Missile Fuels")
    liquid_other_fuels = EnumValue(2, "Liquid - Other Fuels")
    liquid_explosive_material = EnumValue(3, "Liquid Explosive Material")
    solid = EnumValue(4, "Solid")
    gaseous = EnumValue(5, "Gaseous")
    dust_material = EnumValue(6, "Dust Material")
    default = general
