...
class IntercomControlCommunicationsClass(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    simulated_communications_channel = EnumValue(0, "Simulated Communications Channel")
    simulation_support_communications_channel = EnumValue(1, "Simulation Support Communications Channel")
    default = simulated_communications_channel
