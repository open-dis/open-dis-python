...
class ObjectStateModificationArealObjectBitField(ctypes.Structure):
    _fields_ = [
        # (bit position 0, boolean) Describes whether any locations of the areal object have been modified since the last update number,  use {@link UInt8} values for this field
        ("_isLocationModified", UByte, 1)
    ]

class ObjectStateModificationArealObject(ctypes.Union):
    _fields_ = [
        ("capabilities", ObjectStateModificationArealObjectBitField),
        ("asbyte", UInt8)
    ]
