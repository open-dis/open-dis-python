...
class ReceiverReceiverState(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    off = EnumValue(0, "Off")
    on_but_not_receiving = EnumValue(1, "On but not receiving")
    on_and_receiving = EnumValue(2, "On and receiving")
    default = off
