...
class UAPropulsionPlantConfigurationConfiguration(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    diesel_electric = EnumValue(1, "Diesel/Electric")
    diesel = EnumValue(2, "Diesel")
    battery = EnumValue(3, "Battery")
    turbine_reduction = EnumValue(4, "Turbine Reduction")
    steam = EnumValue(6, "Steam")
    gas_turbine = EnumValue(7, "Gas Turbine")
    default = other
