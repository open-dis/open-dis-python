...
class TransmitterAntennaPatternType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    isotropic_spherical_radiation_pattern = EnumValue(0, "Isotropic (Spherical Radiation Pattern)")
    beam = EnumValue(1, "Beam")
    spherical_harmonic = EnumValue(2, "Spherical harmonic")
    transmitter_radiation_volume = EnumValue(4, "Transmitter Radiation Volume")
    beam_and_transmitter_radiation_volume = EnumValue(5, "Beam and Transmitter Radiation Volume")
    omnidirectional_toroidal_radiation_pattern = EnumValue(6, "Omnidirectional (Toroidal Radiation Pattern)")
    default = isotropic_spherical_radiation_pattern
