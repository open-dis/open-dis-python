...
class PlatformSurfaceSupportVesselSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    platform_supply_vessel = EnumValue(1, "Platform Supply Vessel")
    tender_vessel = EnumValue(2, "Tender Vessel")
    tugboat = EnumValue(3, "Tugboat")
    dive_support_vessel = EnumValue(4, "Dive Support Vessel")
    fireboat = EnumValue(5, "Fireboat")
    well_stimulation_vessel_wsv = EnumValue(6, "Well Stimulation Vessel (WSV)")
    anchor_handling_tug_supply_vessel_ahts = EnumValue(7, "Anchor Handling Tug Supply Vessel (AHTS)")
    offshore_construction_vessel_ocv = EnumValue(8, "Offshore Construction Vessel (OCV)")
    emergency_response_and_rescue_vessel_errv = EnumValue(9, "Emergency Response and Rescue Vessel (ERRV)")
    default = platform_supply_vessel
