...
class DataCategory(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    functional_data = EnumValue(1, "Functional Data")
    transponder_interrogator_data_link_messages = EnumValue(2, "Transponder/Interrogator Data Link Messages")
