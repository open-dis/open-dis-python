...
class PlatformSurfacePassengerVesselSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    cruise_ship = EnumValue(1, "Cruise Ship")
    cruise_ferry = EnumValue(2, "Cruise Ferry")
    high_speed_ferry = EnumValue(3, "High Speed Ferry")
    ferry = EnumValue(4, "Ferry")
    ocean_liner = EnumValue(5, "Ocean Liner")
    default = cruise_ship
