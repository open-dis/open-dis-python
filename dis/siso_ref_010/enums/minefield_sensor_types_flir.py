...
class MinefieldSensorTypesFLIR(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    generic_3_5 = EnumValue(0, "Generic 3-5")
    generic_8_12 = EnumValue(1, "Generic 8-12")
    astamids_i = EnumValue(2, "ASTAMIDS I")
    astamids_ii = EnumValue(3, "ASTAMIDS II")
    gstamids_3_5 = EnumValue(4, "GSTAMIDS 3-5")
    gstamids_8_12 = EnumValue(5, "GSTAMIDS 8-12")
    hstamids_3_5 = EnumValue(6, "HSTAMIDS 3-5")
    hstamids_8_12 = EnumValue(7, "HSTAMIDS 8-12")
    cobra_3_5 = EnumValue(8, "COBRA 3-5")
    cobra_8_12 = EnumValue(9, "COBRA 8-12")
    default = generic_3_5
