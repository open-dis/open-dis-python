...
class CCTTSINCGARSClearChannel(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_clear_channel = EnumValue(0, "Not clear channel")
    clear_channel = EnumValue(1, "Clear channel")
    default = not_clear_channel
