...
class EntityVPRecordChangeIndicator(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    initial_report_or_no_change_since_last_issuance = EnumValue(0, "Initial Report or No Change Since Last Issuance")
    change_since_last_issuance = EnumValue(1, "Change Since Last Issuance")
    default = initial_report_or_no_change_since_last_issuance
