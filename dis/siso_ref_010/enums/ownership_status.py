...
class OwnershipStatus(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    new_owner = EnumValue(1, "New Owner")
    ownership_query_response = EnumValue(2, "Ownership Query Response")
    ownership_conflict = EnumValue(3, "Ownership Conflict")
    local_entity_cancelled_auto_resolve_conflict = EnumValue(4, "Local Entity Cancelled - Auto Resolve Conflict")
    local_entity_cancelled_manual_resolve_conflict = EnumValue(5, "Local Entity Cancelled - Manual Resolve Conflict")
    local_entity_cancelled_remove_entity_tcr_received = EnumValue(6, "Local Entity Cancelled - Remove Entity TCR Received")
    default = other
