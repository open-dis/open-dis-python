...
class MinefieldAppearanceLane(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    minefield_has_active_lane = EnumValue(0, "Minefield Has Active Lane")
    minefield_has_an_inactive_lane = EnumValue(1, "Minefield Has an Inactive Lane")
    default = minefield_has_active_lane
