...
class SubcategoriesforLandCategory202Amphibian(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    frog = EnumValue(1, "Frog")
    toad = EnumValue(2, "Toad")
    salamander = EnumValue(170, "Salamander")
    caecilian = EnumValue(230, "Caecilian")
    default = frog
