...
class UAScanPattern(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    scan_pattern_not_used = EnumValue(0, "Scan pattern not used")
    conical = EnumValue(1, "Conical")
    helical = EnumValue(2, "Helical")
    raster = EnumValue(3, "Raster")
    sector_search = EnumValue(4, "Sector search")
    continuous_search = EnumValue(5, "Continuous search")
    default = scan_pattern_not_used
