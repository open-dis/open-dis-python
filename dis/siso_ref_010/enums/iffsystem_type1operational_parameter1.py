...
class IFFSystemType1OperationalParameter1(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_operational_parameter_1_data = EnumValue(0, "No Operational Parameter 1 Data")
    default = no_operational_parameter_1_data
