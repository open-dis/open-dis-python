...
class TimeSlotAllocationLevel(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    low_fidelity_level_0 = EnumValue(0, "Low Fidelity Level 0")
    low_fidelity_level_1 = EnumValue(1, "Low Fidelity Level 1")
    medium_fidelity_level_2 = EnumValue(2, "Medium Fidelity Level 2")
    medium_fidelity_level_3 = EnumValue(3, "Medium Fidelity Level 3")
    high_fidelity_level_4 = EnumValue(4, "High Fidelity Level 4")
    default = low_fidelity_level_0
