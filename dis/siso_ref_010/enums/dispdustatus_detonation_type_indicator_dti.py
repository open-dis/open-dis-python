...
class DISPDUStatusDetonationTypeIndicatorDTI(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    munition = EnumValue(0, "Munition")
    expendable = EnumValue(1, "Expendable")
    non_munition_explosion = EnumValue(2, "Non-munition Explosion")
    default = munition
