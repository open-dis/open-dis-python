...
class Link11MessageSubType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    interrogation = EnumValue(1, "Interrogation")
    data_start = EnumValue(2, "Data Start")
    data = EnumValue(3, "Data")
    data_stop = EnumValue(4, "Data Stop")
