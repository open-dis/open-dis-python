...
class FlareSmokeStatus(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_ignited = EnumValue(0, "Not Ignited")
    burning = EnumValue(1, "Burning")
    burned_out = EnumValue(2, "Burned Out")
    default = not_ignited
