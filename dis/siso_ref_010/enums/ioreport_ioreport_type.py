...
class IOReportIOReportType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    initial_report = EnumValue(1, "Initial Report")
    update_report = EnumValue(2, "Update Report")
    final_report = EnumValue(3, "Final Report")
