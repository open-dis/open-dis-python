...
class CulturalFeatureCapabilitiesBitField(ctypes.Structure):
    _fields_ = [
...
class CulturalFeatureCapabilities(ctypes.Union):
    _fields_ = [
        ("capabilities", CulturalFeatureCapabilitiesBitField),
        ("asbyte", UInt8)
    ]
