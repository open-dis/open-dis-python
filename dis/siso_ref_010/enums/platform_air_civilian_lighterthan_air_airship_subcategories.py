...
class PlatformAirCivilianLighterthanAirAirshipSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    non_rigid_blimp = EnumValue(1, "Non-rigid (blimp)")
    semi_rigid = EnumValue(2, "Semi-rigid")
    rigid = EnumValue(3, "Rigid")
    hybrid = EnumValue(4, "Hybrid")
    default = non_rigid_blimp
