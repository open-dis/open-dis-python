...
class IOEffectsRecordIOLinkType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    logical_link = EnumValue(1, "Logical Link")
    physical_node = EnumValue(2, "Physical Node")
    physical_link = EnumValue(3, "Physical Link")
