...
class RepairGroups(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    general_repair_codes = EnumValue(0, "General Repair Codes")
    drive_train = EnumValue(1, "Drive Train")
    hull_airframe_body = EnumValue(2, "Hull/Airframe/Body")
    interfaces_with_environment = EnumValue(3, "Interfaces with Environment")
    weapons = EnumValue(4, "Weapons")
    fuel_systems = EnumValue(5, "Fuel Systems")
    electronics = EnumValue(6, "Electronics")
    life_support_systems = EnumValue(7, "Life Support Systems")
    hydraulic_systems_and_actuators = EnumValue(8, "Hydraulic Systems and Actuators")
    auxiliary_craft = EnumValue(9, "Auxiliary Craft")
    default = general_repair_codes
