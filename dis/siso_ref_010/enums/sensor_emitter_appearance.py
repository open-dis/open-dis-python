...
class SensorEmitterAppearanceBitField(ctypes.Structure):
    _fields_ = [
        ...
        # (bit position 2, boolean) Describes whether it is capable of carrying out its mission (e.g., damaged antenna),  use {@link UInt8} values for this field
        ("_missionKilled", UByte, 1),
        ...
        # (bit position 12, boolean) Describes whether the lights are on or off,  use {@link UInt8} values for this field
        ("_lightsOn", UByte, 1),
        ...
        # (bit position 16, boolean) Describes whether the antenna is raised or not,  use {@link UInt8} values for this field
        ("_antennaRaised", UByte, 1),
...
class SensorEmitterAppearance(ctypes.Union):
    _fields_ = [
        ("capabilities", SensorEmitterAppearanceBitField),
        ("asbyte", UInt8)
    ]
    ...
    def set_missionKilled(self, value : UInt8):
        self.capabilities._missionKilled = int(value)
    def get_missionKilled(self) -> UInt8:
        return self.capabilities._missionKilled
    MissionKilled = property(get_missionKilled, set_missionKilled)
    ...
    def set_lightsOn(self, value : UInt8):
        self.capabilities._lightsOn = int(value)
    def get_lightsOn(self) -> UInt8:
        return self.capabilities._lightsOn
    LightsOn = property(get_lightsOn, set_lightsOn)
    ...
    def set_antennaRaised(self, value : UInt8):
        self.capabilities._antennaRaised = int(value)
    def get_antennaRaised(self) -> UInt8:
        return self.capabilities._antennaRaised
    AntennaRaised = property(get_antennaRaised, set_antennaRaised)
