...
class SISOSTD002Version(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    siso_std_002_2006 = EnumValue(0, "SISO-STD-002-2006")
    siso_std_002_2021 = EnumValue(1, "SISO-STD-002-2021")
    default = siso_std_002_2006
