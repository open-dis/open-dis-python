...
class PlatformLandMotorcycleSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    scooter_small = EnumValue(1, "Scooter (Small)")
    sport_street_mid_size = EnumValue(2, "Sport/Street (Mid-Size)")
    cruiser_large = EnumValue(3, "Cruiser (Large)")
    dirt_bike = EnumValue(4, "Dirt Bike")
    standard = EnumValue(5, "Standard")
    touring = EnumValue(6, "Touring")
    dual_purpose = EnumValue(7, "Dual Purpose")
    default = other
