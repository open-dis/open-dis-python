...
class AppearanceLinearObjectTankDitchBreach(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_breaching = EnumValue(0, "No Breaching")
    slight_breaching = EnumValue(1, "Slight Breaching")
    moderate_breached = EnumValue(2, "Moderate Breached")
    cleared = EnumValue(3, "Cleared")
    default = no_breaching
