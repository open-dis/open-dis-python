...
class MinefieldSensorTypes(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    # XREF UID 194 - CLASS MinefieldSensorTypesOptical 
    optical = EnumValue(1, "Optical")
    # XREF UID 195 - CLASS MinefieldSensorTypesFLIR 
    flir = EnumValue(2, "FLIR")
    # XREF UID 196 - CLASS MinefieldSensorTypesRADAR 
    radar = EnumValue(3, "RADAR")
    # XREF UID 197 - CLASS MinefieldSensorTypesMagnetic 
    magnetic = EnumValue(4, "Magnetic")
    # XREF UID 198 - CLASS MinefieldSensorTypesLaser 
    laser = EnumValue(5, "Laser")
    # XREF UID 199 - CLASS MinefieldSensorTypesSONAR 
    sonar = EnumValue(6, "SONAR")
    # XREF UID 200 - CLASS MinefieldSensorTypesPhysical 
    physical = EnumValue(7, "Physical")
    # XREF UID 201 - CLASS MinefieldSensorTypesMultispectral 
    multispectral = EnumValue(8, "Multispectral")
    default = other
