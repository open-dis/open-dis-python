...
class LifeFormHumanSpecificDroneGuns(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    dronegun_tactical = EnumValue(15, "DroneGun Tactical")
    dronegun_mkii = EnumValue(16, "DroneGun MKII")
    default = other
