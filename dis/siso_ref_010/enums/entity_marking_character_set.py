...
class EntityMarkingCharacterSet(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    unused = EnumValue(0, "Unused")
    ascii = EnumValue(1, "ASCII")
    us_army_marking = EnumValue(2, "U.S. Army Marking")
    digit_chevron = EnumValue(3, "Digit Chevron")
    default = unused
