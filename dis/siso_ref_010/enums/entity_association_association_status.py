...
class EntityAssociationAssociationStatus(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_specified = EnumValue(0, "Not Specified")
    physical_association_general_object_1 = EnumValue(1, "Physical Association (General/Object 1)")
    functional_association_general = EnumValue(2, "Functional Association (General)")
    association_broken = EnumValue(3, "Association Broken")
    physical_association_object_2 = EnumValue(4, "Physical Association (Object 2)")
    functional_association_object_1 = EnumValue(5, "Functional Association (Object 1)")
    functional_association_object_2 = EnumValue(6, "Functional Association (Object 2)")
