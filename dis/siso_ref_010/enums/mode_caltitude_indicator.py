...
class ModeCAltitudeIndicator(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    positive_altitude_above_msl = EnumValue(0, "Positive Altitude Above MSL")
    negative_altitude_below_msl_use_alternate_mode_c_altitude = EnumValue(1, "Negative Altitude Below MSL/Use Alternate Mode C Altitude")
    default = positive_altitude_above_msl
