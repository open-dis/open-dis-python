...
class AcknowledgeAcknowledgeFlag(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    create_entity = EnumValue(1, "Create Entity")
    remove_entity = EnumValue(2, "Remove Entity")
    start_resume = EnumValue(3, "Start/Resume")
    stop_freeze = EnumValue(4, "Stop/Freeze")
    transfer_ownership = EnumValue(5, "Transfer Ownership")
    default = create_entity
