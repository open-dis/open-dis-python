...
class AircraftAddressSource(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    mode_s_aircraft_address_field_value = EnumValue(0, "Mode S Aircraft Address Field Value")
    gicb_iff_data_record_available = EnumValue(1, "GICB IFF Data Record Available")
    default = mode_s_aircraft_address_field_value
