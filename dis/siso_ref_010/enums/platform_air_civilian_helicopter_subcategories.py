...
class PlatformAirCivilianHelicopterSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    single_rotor_piston_engine = EnumValue(11, "Single Rotor, Piston Engine")
    single_rotor_turboshaft_engine_conventional_tail_rotor = EnumValue(12, "Single Rotor, Turboshaft Engine, Conventional Tail Rotor")
    single_rotor_turboshaft_engine_shrouded_tail_rotor = EnumValue(13, "Single Rotor, Turboshaft Engine, Shrouded Tail Rotor")
    single_rotor_turboshaft_engine_no_tail_rotor = EnumValue(14, "Single Rotor, Turboshaft Engine, No Tail Rotor")
    tandem_rotor = EnumValue(21, "Tandem Rotor")
    coaxial_rotor = EnumValue(22, "Coaxial Rotor")
    intermeshing_rotor = EnumValue(23, "Intermeshing Rotor")
    default = single_rotor_piston_engine
