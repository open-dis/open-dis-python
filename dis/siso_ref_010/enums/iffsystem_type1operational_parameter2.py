...
class IFFSystemType1OperationalParameter2(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_operational_parameter_2_data = EnumValue(0, "No Operational Parameter 2 Data")
    default = no_operational_parameter_2_data
