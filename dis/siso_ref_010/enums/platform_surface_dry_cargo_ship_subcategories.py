...
class PlatformSurfaceDryCargoShipSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    common_dry_cargo_ship = EnumValue(1, "Common Dry Cargo Ship")
    dry_bulk_cargo_ship = EnumValue(2, "Dry Bulk Cargo Ship")
    container_ship = EnumValue(3, "Container Ship")
    reefer_ship_refrigerator_ship = EnumValue(4, "Reefer Ship (Refrigerator Ship)")
    ro_ro_ship_roll_on_roll_off_ship = EnumValue(5, "Ro-Ro Ship (Roll-on/Roll-off Ship)")
    barge = EnumValue(6, "Barge")
    heavy_lift_ship = EnumValue(7, "Heavy Lift Ship")
    default = common_dry_cargo_ship
