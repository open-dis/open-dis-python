...
class AppearancePaintScheme(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    uniform_color = EnumValue(0, "Uniform Color")
    camouflage = EnumValue(1, "Camouflage")
    default = uniform_color
