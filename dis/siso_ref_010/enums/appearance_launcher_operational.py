...
class AppearanceLauncherOperational(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_raised_not_operational = EnumValue(0, "Not Raised/Not Operational")
    raised_operational = EnumValue(1, "Raised/Operational")
    default = not_raised_not_operational
