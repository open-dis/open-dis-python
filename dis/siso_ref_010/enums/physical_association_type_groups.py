...
class PhysicalAssociationTypeGroups(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_specified = EnumValue(0, "Not Specified")
    towed_mounted_sling_load = EnumValue(1, "Towed / Mounted / Sling Load")
    restrained = EnumValue(2, "Restrained")
    mission = EnumValue(3, "Mission")
    other_connections = EnumValue(4, "Other Connections")
