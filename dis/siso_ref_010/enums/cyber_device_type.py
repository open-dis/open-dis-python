...
class CyberDeviceType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    generic = EnumValue(1, "Generic")
    networking = EnumValue(2, "Networking")
    computer_node = EnumValue(3, "Computer Node")
    portable_computer = EnumValue(4, "Portable Computer")
    controller = EnumValue(5, "Controller")
    storage = EnumValue(6, "Storage")
    sensor = EnumValue(7, "Sensor")
    printer = EnumValue(8, "Printer")
    scanner = EnumValue(9, "Scanner")
    communications = EnumValue(10, "Communications")
    hmi = EnumValue(11, "HMI")
    monitoring = EnumValue(12, "Monitoring")
    iot = EnumValue(13, "IoT")
    security = EnumValue(14, "Security")
    default = generic
