...
class DISPDUStatusLVCIndicatorLVC(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    live = EnumValue(1, "Live")
    Virtual = EnumValue(2, "Virtual")
    constructive = EnumValue(3, "Constructive")
