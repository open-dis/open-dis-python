...
class AddVariantsforAirCategory201Insect(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    vertical_shaped_insect_swarm = EnumValue(1, "Vertical Shaped Insect Swarm")
    circular_shaped_insect_swarm = EnumValue(2, "Circular Shaped Insect Swarm")
    irregular_shaped_insect_swarm = EnumValue(3, "Irregular Shaped Insect Swarm")
    default = vertical_shaped_insect_swarm
