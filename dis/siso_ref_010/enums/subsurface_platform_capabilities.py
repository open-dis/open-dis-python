...
class SubsurfacePlatformCapabilitiesBitField(ctypes.Structure):
    _fields_ = [
...
class SubsurfacePlatformCapabilities(ctypes.Union):
    _fields_ = [
        ("capabilities", SubsurfacePlatformCapabilitiesBitField),
        ("asbyte", UInt8)
    ]
