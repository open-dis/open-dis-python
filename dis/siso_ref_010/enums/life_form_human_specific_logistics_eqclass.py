...
class LifeFormHumanSpecificLogisticsEQClass(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    sling_load_pendant = EnumValue(1, "Sling Load Pendant")
    default = sling_load_pendant
