...
class AppearanceLinearObjectLaneMarkerVisible(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    left_side_is_visible = EnumValue(0, "Left Side Is Visible")
    right_side_is_visible = EnumValue(1, "Right Side Is Visible")
    both_sides_are_visible = EnumValue(2, "Both Sides Are Visible")
    default = left_side_is_visible
