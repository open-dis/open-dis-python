...
class CyberCyberEventPhaseType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    start = EnumValue(1, "Start")
    suspend = EnumValue(2, "Suspend")
    continue = EnumValue(3, "Continue")
    continue_with_changes = EnumValue(4, "Continue With Changes")
    end = EnumValue(5, "End")
    cancel = EnumValue(6, "Cancel")
    default = start
