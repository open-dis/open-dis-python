...
class LifeFormsSubcategoryUKWeapons(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    law_80 = EnumValue(1, "LAW 80")
    blowpipe = EnumValue(2, "Blowpipe")
    javelin = EnumValue(3, "Javelin")
    _51_mm_mortar = EnumValue(4, "51-mm mortar")
    slr_762_mm_rifle = EnumValue(5, "SLR 7.62-mm rifle")
    sterling_9_mm_submachine_gun = EnumValue(6, "Sterling 9-mm submachine gun")
    l7a2_general_purpose_mg = EnumValue(7, "L7A2 general purpose MG")
    l6_wombat_recoilless_rifle_ = EnumValue(8, "L6 Wombat Recoilless rifle,")
    carl_gustav_89_mm_recoilless_rifle = EnumValue(9, "Carl Gustav 89-mm recoilless rifle")
    sa80_individual_light_support_weapon = EnumValue(10, "SA80 Individual/light support weapon")
    trigat = EnumValue(11, "Trigat")
    milan_at_missile = EnumValue(12, "Milan AT missile")
    default = law_80
