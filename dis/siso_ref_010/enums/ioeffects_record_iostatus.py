...
class IOEffectsRecordIOStatus(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    effect_on_sender = EnumValue(1, "Effect on Sender")
    effect_on_receiver = EnumValue(2, "Effect on Receiver")
    effect_on_sender_and_receiver = EnumValue(3, "Effect on Sender and Receiver")
    effect_on_message = EnumValue(4, "Effect on Message")
    effect_on_sender_and_message = EnumValue(5, "Effect on Sender and Message")
    effect_on_receiver_and_message = EnumValue(6, "Effect on Receiver and Message")
    effect_on_sender_receiver_and_message = EnumValue(7, "Effect on Sender, Receiver, and Message")
