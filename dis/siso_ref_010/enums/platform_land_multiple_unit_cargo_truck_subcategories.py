...
class PlatformLandMultipleUnitCargoTruckSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    tractor_trailer = EnumValue(1, "Tractor Trailer")
    tanker = EnumValue(2, "Tanker")
    default = other
