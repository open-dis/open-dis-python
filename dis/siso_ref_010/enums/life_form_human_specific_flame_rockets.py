...
class LifeFormHumanSpecificFlameRockets(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    _66mm_m202_flash = EnumValue(20, "66mm M202 Flash")
    _62mm_fhj_84 = EnumValue(30, "62mm FHJ-84")
    _90mm_c90_cr_fim_m3 = EnumValue(40, "90mm C90-CR-FIM (M3)")
    _93mm_rpo_a_shmel = EnumValue(50, "93mm RPO-A Shmel")
    _93mm_rpo_z_shmel = EnumValue(51, "93mm RPO-Z Shmel")
    _93mm_rpo_d_shmel = EnumValue(52, "93mm RPO-D Shmel")
    default = other
