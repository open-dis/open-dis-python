...
class CyberDataType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    file = EnumValue(1, "File")
    code = EnumValue(2, "Code")
    credentials = EnumValue(3, "Credentials")
    communications = EnumValue(4, "Communications")
    system_configuration = EnumValue(5, "System Configuration")
    default = file
