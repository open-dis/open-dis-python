...
class SubcategoriesforSubsurfaceCategory204Insect(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    sea_skater = EnumValue(1, "Sea Skater")
    water_beetle = EnumValue(2, "Water Beetle")
    default = sea_skater
