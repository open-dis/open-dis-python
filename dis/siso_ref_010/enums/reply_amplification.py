...
class ReplyAmplification(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    complete = EnumValue(1, "Complete")
    limted = EnumValue(2, "Limted")
    unable_to_respond = EnumValue(3, "Unable to Respond")
