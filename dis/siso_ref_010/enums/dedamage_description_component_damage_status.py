...
class DEDamageDescriptionComponentDamageStatus(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_damage = EnumValue(0, "No Damage")
    minor_damage = EnumValue(1, "Minor Damage")
    medium_damage = EnumValue(2, "Medium Damage")
    major_damage = EnumValue(3, "Major Damage")
    destroyed = EnumValue(4, "Destroyed")
    default = no_damage
