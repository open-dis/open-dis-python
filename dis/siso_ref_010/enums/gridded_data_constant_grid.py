...
class GriddedDataConstantGrid(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    constant_grid = EnumValue(0, "Constant grid")
    updated_grid = EnumValue(1, "Updated grid")
    default = constant_grid
