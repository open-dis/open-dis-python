...
class VariantsforAirCategory200Bird(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    bird_with_fish = EnumValue(1, "Bird with Fish")
    v_pattern_flock_shape = EnumValue(2, "V-Pattern Flock Shape")
    circular_flock_shape = EnumValue(3, "Circular Flock Shape")
    irregular_flock_shape = EnumValue(4, "Irregular Flock Shape")
    default = bird_with_fish
