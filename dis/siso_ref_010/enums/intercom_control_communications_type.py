...
class IntercomControlCommunicationsType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    reserved = EnumValue(0, "Reserved")
    connection_fdx = EnumValue(1, "Connection FDX")
    connection_hdx_destination_is_receive_only = EnumValue(2, "Connection HDX - Destination is Receive Only")
    connection_hdx_destination_is_transmit_only = EnumValue(3, "Connection HDX - Destination is Transmit Only")
    connection_hdx = EnumValue(4, "Connection HDX")
    default = reserved
