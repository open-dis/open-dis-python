...
class Class11SupplyCategorySuppliesNonDoctrinal(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(1, "Other")
    pallets = EnumValue(2, "Pallets")
    fuel_tanks_drums_and_bladders = EnumValue(3, "Fuel Tanks, Drums and Bladders")
    chests = EnumValue(4, "Chests")
    boxes = EnumValue(5, "Boxes")
    default = other
