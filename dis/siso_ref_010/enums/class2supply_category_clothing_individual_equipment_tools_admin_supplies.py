...
class Class2SupplyCategoryClothingIndividualEquipmentToolsAdminSupplies(ExtensibleEnum, metaclass=EnumMeta):
    ...
    e_general_supplies = EnumValue(4, "E - General Supplies")
    f_clothing = EnumValue(5, "F - Clothing")
    g_electronics = EnumValue(6, "G - Electronics")
    m_weapons_humans = EnumValue(7, "M - Weapons (Humans)")
    t_industrial_supplies = EnumValue(8, "T - Industrial Supplies")
    default = other
