...
class GridAxisDescriptorAxisType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    regular_axis = EnumValue(0, "Regular Axis")
    irregular_axis = EnumValue(1, "Irregular Axis")
    default = regular_axis
