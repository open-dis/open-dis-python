...
class ObjectKind(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    obstacle = EnumValue(1, "Obstacle")
    prepared_position = EnumValue(2, "Prepared Position")
    cultural_feature = EnumValue(3, "Cultural Feature")
    passageway = EnumValue(4, "Passageway")
    tactical_smoke = EnumValue(5, "Tactical Smoke")
    obstacle_marker = EnumValue(6, "Obstacle Marker")
    obstacle_breach = EnumValue(7, "Obstacle Breach")
    environmental_object = EnumValue(8, "Environmental Object")
    default = other
