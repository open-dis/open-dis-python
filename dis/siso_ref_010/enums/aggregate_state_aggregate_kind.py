...
class AggregateStateAggregateKind(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    military_hierarchy = EnumValue(1, "Military Hierarchy")
    common_type = EnumValue(2, "Common Type")
    common_mission = EnumValue(3, "Common Mission")
    similar_capabilities = EnumValue(4, "Similar Capabilities")
    common_location = EnumValue(5, "Common Location")
    default = other
