...
class PlatformLandFarmSpecialtyVehicleSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    tractor = EnumValue(1, "Tractor")
    harvester_reaper = EnumValue(2, "Harvester/Reaper")
    skidder = EnumValue(3, "Skidder")
    forwarder = EnumValue(4, "Forwarder")
    lawn_mower_other = EnumValue(5, "Lawn Mower, Other")
    lawn_mower_riding = EnumValue(6, "Lawn Mower, Riding")
    lawn_mower_standing = EnumValue(7, "Lawn Mower, Standing")
    lawn_mower_push = EnumValue(8, "Lawn Mower, Push")
    default = other
