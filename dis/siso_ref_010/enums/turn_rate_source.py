...
class TurnRateSource(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    compute_locally = EnumValue(0, "Compute Locally")
    less_than_1_degree_turn_or_not_turning = EnumValue(1, "Less Than 1-Degree Turn or Not Turning")
    _1_degree_or_greater_turn_rate = EnumValue(2, "1-Degree or Greater Turn Rate")
    default = compute_locally
