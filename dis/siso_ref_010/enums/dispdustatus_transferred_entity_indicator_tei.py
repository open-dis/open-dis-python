...
class DISPDUStatusTransferredEntityIndicatorTEI(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_difference = EnumValue(0, "No Difference")
    difference = EnumValue(1, "Difference")
