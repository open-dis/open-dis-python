...
class AppearanceLifeFormWeaponImplement(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_present = EnumValue(0, "Not Present")
    stowed = EnumValue(1, "Stowed")
    deployed_active = EnumValue(2, "Deployed/Active")
    firing_position_in_use = EnumValue(3, "Firing Position/In Use")
    default = not_present
