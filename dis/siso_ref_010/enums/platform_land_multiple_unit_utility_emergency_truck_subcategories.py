...
class PlatformLandMultipleUnitUtilityEmergencyTruckSubcategories(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(0, "Other")
    fire_engine_hook_and_ladder = EnumValue(1, "Fire Engine, Hook And Ladder")
    default = other
