...
class MinefieldFusingFuseType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_fuse = EnumValue(0, "No Fuse")
    other = EnumValue(1, "Other")
    pressure = EnumValue(2, "Pressure")
    magnetic = EnumValue(3, "Magnetic")
    tilt_rod = EnumValue(4, "Tilt Rod")
    command = EnumValue(5, "Command")
    trip_wire = EnumValue(6, "Trip Wire")
    default = no_fuse
