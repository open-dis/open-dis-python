...
class SubcategoriesforSubsurfaceCategory202Mollusk(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    snail = EnumValue(1, "Snail")
    slug = EnumValue(10, "Slug")
    octopus = EnumValue(20, "Octopus")
    squid = EnumValue(30, "Squid")
    cuttlefish = EnumValue(40, "Cuttlefish")
    clam = EnumValue(50, "Clam")
    muscle = EnumValue(60, "Muscle")
    oyster = EnumValue(70, "Oyster")
    scallop = EnumValue(80, "Scallop")
    default = snail
