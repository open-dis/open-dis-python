...
class CyberAdminType(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    administration = EnumValue(1, "Administration")
    assessment = EnumValue(2, "Assessment")
    collection = EnumValue(3, "Collection")
    configuration = EnumValue(4, "Configuration")
    evaluation = EnumValue(5, "Evaluation")
    forensics = EnumValue(6, "Forensics")
    investigation = EnumValue(7, "Investigation")
    operations = EnumValue(8, "Operations")
    provisioning = EnumValue(9, "Provisioning")
    testing = EnumValue(10, "Testing")
