...
class Mode5IFFMission(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    no_statement = EnumValue(0, "No Statement")
    surveillance_shorad = EnumValue(1, "Surveillance SHORAD")
    shorad_associated_with_a_weapons_system = EnumValue(2, "SHORAD associated with a Weapons System")
    weapon_system = EnumValue(3, "Weapon System")
    airborne_and_surface_ship_surveillance_platforms = EnumValue(4, "Airborne and Surface (Ship) Surveillance Platforms")
    airborne_and_surface_ship_weapons_platforms = EnumValue(5, "Airborne and Surface (Ship) Weapons Platforms")
    ground_to_ground = EnumValue(6, "Ground-to-Ground")
