...
class LifeFormsSubcategoryFrenchWeapons(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    acl_strim = EnumValue(1, "ACL-STRIM")
    mistral_missile = EnumValue(2, "Mistral missile")
    milan_at_missile = EnumValue(3, "Milan AT missile")
    lrac_f1_89_mm_at_rocket_launcher = EnumValue(4, "LRAC F1 89-mm AT rocket launcher")
    fa_mas_rifle = EnumValue(5, "FA-MAS rifle")
    aa_52_machine_gun = EnumValue(6, "AA-52 machine gun")
    _58_mm_rifle_grenade = EnumValue(7, "58-mm rifle grenade")
    fr_f1_sniper_rifle = EnumValue(8, "FR-F1 sniper rifle")
    default = acl_strim
