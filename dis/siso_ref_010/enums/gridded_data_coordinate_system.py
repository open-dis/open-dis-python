...
class GriddedDataCoordinateSystem(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    right_handed_cartesian_local_topographic_projection_east_north_up = EnumValue(0, "Right handed Cartesian (local topographic projection: east, north, up)")
    left_handed_cartesian_local_topographic_projection_east_north_down = EnumValue(1, "Left handed Cartesian (local topographic projection: east, north, down)")
    latitude_longitude_height = EnumValue(2, "Latitude, Longitude, Height")
    latitude_longitude_depth = EnumValue(3, "Latitude, Longitude, Depth")
    default = right_handed_cartesian_local_topographic_projection_east_north_up
