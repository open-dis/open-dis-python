...
class AddVariantsforLandCategory200Mammal(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    animal_with_a_male_child_rider = EnumValue(1, "Animal with a Male Child Rider")
    animal_with_a_female_child_rider = EnumValue(2, "Animal with a Female Child Rider")
    animal_with_an_adult_male_rider = EnumValue(3, "Animal with an Adult Male Rider")
    animal_with_an_adult_female_rider = EnumValue(4, "Animal with an Adult Female Rider")
    animal_harnessed_to_a_plow = EnumValue(5, "Animal Harnessed to a Plow")
    animal_harnessed_to_a_cart = EnumValue(6, "Animal Harnessed to a Cart")
    default = animal_with_a_male_child_rider
