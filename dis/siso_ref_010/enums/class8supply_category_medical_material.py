...
class Class8SupplyCategoryMedicalMaterial(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    other = EnumValue(1, "Other")
    a_medical_materiel = EnumValue(2, "A - Medical Materiel")
    b_blood_fluids = EnumValue(3, "B - Blood / Fluids")
    default = other
