...
class AppearanceHatch(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    not_applicable = EnumValue(0, "Not Applicable")
    closed = EnumValue(1, "Closed")
    popped = EnumValue(2, "Popped")
    popped_and_person_is_visible = EnumValue(3, "Popped and Person Is Visible")
    open = EnumValue(4, "Open")
    open_and_person_is_visible = EnumValue(5, "Open and Person Is Visible")
