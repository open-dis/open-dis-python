...
class CoverShroudStatus(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    closed = EnumValue(0, "Closed")
    opening = EnumValue(1, "Opening")
    cover_shroud_blown_detached = EnumValue(2, "Cover/Shroud Blown/Detached")
    open_attached = EnumValue(3, "Open/Attached")
    default = closed
