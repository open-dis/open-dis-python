...
class MinefieldSensorTypesMagnetic(ExtensibleEnum, metaclass=EnumMeta):
    UNKNOWN = EnumValue(-1, "UNKNOWN Enum")
    generic = EnumValue(0, "Generic")
    an_pss_11 = EnumValue(1, "AN-PSS-11")
    an_pss_12 = EnumValue(2, "AN-PSS-12")
    gstamids = EnumValue(3, "GSTAMIDS")
    default = generic
