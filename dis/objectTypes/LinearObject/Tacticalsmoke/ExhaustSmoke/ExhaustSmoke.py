 ...
 * package edu.nps.moves.dis7.enumerations.LinearObject.Tacticalsmoke.ExhaustSmoke;
...
class ExhaustSmoke(ObjectType):
   def __init__(self):
        domain = PlatformDomain(0)  # LinearObject
        objectKind = ObjectKind(5)  # Tactical smoke
        category = UInt8(1)  # Exhaust Smoke
