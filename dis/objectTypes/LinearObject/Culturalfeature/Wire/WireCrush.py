 ...
 * package edu.nps.moves.dis7.enumerations.LinearObject.Culturalfeature.Wire;
...
class WireCrush(ObjectType):
   def __init__(self):
        domain = PlatformDomain(1)  # LinearObject
        objectKind = ObjectKind(3)  # Cultural feature
        category = UInt8(1)  # Wire
        subCategory = UInt8(1)  # Wire, Crush
