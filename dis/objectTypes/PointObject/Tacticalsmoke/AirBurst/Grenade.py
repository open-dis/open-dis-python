 ...
 * package edu.nps.moves.dis7.enumerations.PointObject.Tacticalsmoke.AirBurst;
...
class Grenade(ObjectType):
   def __init__(self):
        domain = PlatformDomain(0)  # PointObject
        objectKind = ObjectKind(5)  # Tactical smoke
        category = UInt8(2)  # Air Burst
        subCategory = UInt8(1)  # Grenade
