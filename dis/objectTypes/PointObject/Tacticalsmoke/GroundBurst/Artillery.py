 ...
 * package edu.nps.moves.dis7.enumerations.PointObject.Tacticalsmoke.GroundBurst;
...
class Artillery(ObjectType):
   def __init__(self):
        domain = PlatformDomain(0)  # PointObject
        objectKind = ObjectKind(5)  # Tactical smoke
        category = UInt8(1)  # Ground Burst
        subCategory = UInt8(1)  # Artillery
