 ...
 * package edu.nps.moves.dis7.enumerations.PointObject.Obstacle.LogCrib;
...
class Rectangular(ObjectType):
   def __init__(self):
        domain = PlatformDomain(1)  # PointObject
        objectKind = ObjectKind(1)  # Obstacle
        category = UInt8(2)  # Log Crib
        subCategory = UInt8(1)  # Rectangular
