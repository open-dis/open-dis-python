 ...
 * package edu.nps.moves.dis7.enumerations.PointObject.Culturalfeature.TreeEvergreen;
...
class TreeEvergreenMedium(ObjectType):
   def __init__(self):
        domain = PlatformDomain(1)  # PointObject
        objectKind = ObjectKind(3)  # Cultural feature
        category = UInt8(11)  # Tree, Evergreen
        subCategory = UInt8(2)  # Tree, Evergreen, Medium
