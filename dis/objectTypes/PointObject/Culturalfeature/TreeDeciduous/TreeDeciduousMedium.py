 ...
 * package edu.nps.moves.dis7.enumerations.PointObject.Culturalfeature.TreeDeciduous;
...
class TreeDeciduousMedium(ObjectType):
   def __init__(self):
        domain = PlatformDomain(1)  # PointObject
        objectKind = ObjectKind(3)  # Cultural feature
        category = UInt8(10)  # Tree, Deciduous
        subCategory = UInt8(2)  # Tree, Deciduous, Medium
