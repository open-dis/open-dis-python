 ...
 * package edu.nps.moves.dis7.enumerations.PointObject.Culturalfeature.MOUTBuilding;
...
class MOUTBuildingOfficeBuilding(ObjectType):
   def __init__(self):
        domain = PlatformDomain(1)  # PointObject
        objectKind = ObjectKind(3)  # Cultural feature
        category = UInt8(7)  # MOUT Building
        subCategory = UInt8(5)  # MOUT Building, Office Building
