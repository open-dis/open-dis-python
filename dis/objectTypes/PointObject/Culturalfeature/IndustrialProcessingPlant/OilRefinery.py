 ...
 * package edu.nps.moves.dis7.enumerations.PointObject.Culturalfeature.IndustrialProcessingPlant;
...
class OilRefinery(ObjectType):
   def __init__(self):
        domain = PlatformDomain(1)  # PointObject
        objectKind = ObjectKind(3)  # Cultural feature
        category = UInt8(13)  # Industrial Processing Plant
        subCategory = UInt8(1)  # Oil Refinery
