 ...
 * package edu.nps.moves.dis7.enumerations.PointObject.Culturalfeature.DisturbedRoad;
...
class DisturbedRoadConcrete(ObjectType):
   def __init__(self):
        domain = PlatformDomain(1)  # PointObject
        objectKind = ObjectKind(3)  # Cultural feature
        category = UInt8(4)  # Disturbed Road
        subCategory = UInt8(3)  # Disturbed Road, Concrete
