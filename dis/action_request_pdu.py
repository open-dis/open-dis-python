...
from .siso_ref_010.enums.action_request_action_id import ActionRequestActionID
...
class ActionRequestPdu( SimulationManagementFamilyPdu ):
    ...
    def __init__(self):
        ...
        self.actionID = ActionRequestActionID.default
    ...
    ///            Kind : OBJECT_LIST
    ///    Marshal Size : 8
    ///         Comment : variable length list of fixed datums
    ///   default value : null
    ///     is Bitfield : false
    ///     List Length : 0
    ///     Prim Length : false
    ...
    def serialize(self, outputStream):
        ...
        self.serialize_enum(self.actionID,outputStream)
    ...
    def parse(self, inputStream):
        ...
        self.actionID = ActionRequestActionID.get_enum(self.parse_enum(self.actionID,inputStream))
