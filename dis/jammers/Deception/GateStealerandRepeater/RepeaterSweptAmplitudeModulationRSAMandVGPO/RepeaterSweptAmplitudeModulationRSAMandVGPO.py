...
class RepeaterSweptAmplitudeModulationRSAMandVGPO(JammingTechnique):
    def __init__(self):
        self.kind = 2 // Deception
        self.category = 80 // Gate Stealer and Repeater
        self.subCategory = 5 // Repeater Swept Amplitude Modulation (RSAM) and VGPO
