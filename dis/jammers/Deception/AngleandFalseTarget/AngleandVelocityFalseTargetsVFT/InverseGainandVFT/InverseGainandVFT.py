...
class InverseGainandVFT(JammingTechnique):
    def __init__(self):
        self.kind = 2 // Deception
        self.category = 20 // Angle and False Target
        self.subCategory = 5 // Angle and Velocity False Targets (VFT)
        self.specific = 5 // Inverse Gain and VFT
