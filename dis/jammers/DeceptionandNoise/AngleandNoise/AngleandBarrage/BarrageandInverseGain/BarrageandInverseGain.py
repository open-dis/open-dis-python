...
class BarrageandInverseGain(JammingTechnique):
    def __init__(self):
        self.kind = 3 // Deception and Noise
        self.category = 5 // Angle and Noise
        self.subCategory = 5 // Angle and Barrage
        self.specific = 5 // Barrage and Inverse Gain
