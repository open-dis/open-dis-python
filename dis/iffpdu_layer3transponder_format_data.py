...
from .mode5transponder_basic_data import Mode5TransponderBasicData
from .iffdata_specification import IFFDataSpecification
from .abstract_iffpdu_layer_data import AbstractIFFPduLayerData

class IFFPduLayer3TransponderFormatData( AbstractIFFPduLayerData ):
    """7.6.5.4.3 Layer 3 Mode 5 transponder format"""

    def __init__(self):
        """ Initializer for IFFPduLayer3TransponderFormatData"""
        super().__init__()
        """ Layer header"""
        ...
        self.mode5TransponderBasicData = Mode5TransponderBasicData()
        """ Padding"""
        self.padding = 0
    ...
    def serialize(self, outputStream):
        """serialize the class """
        super( IFFPduLayer3TransponderFormatData, self ).serialize(outputStream)
        ...
        self.mode5TransponderBasicData.serialize(outputStream)
