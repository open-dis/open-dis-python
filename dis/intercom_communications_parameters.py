...
from .siso_ref_010.enums.intercom_control_record_type import IntercomControlRecordType
...
class IntercomCommunicationsParameters( object ):
    ...
    def __init__(self):
        ...
        self.recordType = IntercomControlRecordType.default
    ...
    def to_string(self) ->str:
        outputString = ""
        outputString += "IntercomControlRecordType : " + self.recordType.get_description + "(" + (str(int(self.recordType))) + ")" + "\n"
        outputString += "RecordLength : " + str(self.recordLength) + "\n"
        outputString += "RecordSpecificField : " + "\n"
        for idx in range(0, len(self.recordSpecificField)):
            outputString += str(self.recordSpecificField[idx])
    ...
    def parse(self, inputStream):
        ...
        self.recordType = IntercomControlRecordType.get_enum(self.parse_enum(self.recordType,inputStream))
