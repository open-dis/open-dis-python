...
from .siso_ref_010.enums.ownership_status import OwnershipStatus
...
class OwnershipStatusRecord( object ):
    ...
    def __init__(self):
        ...
        self.ownershipStatus = OwnershipStatus.default
    ...
    def serialize(self, outputStream):
        ...
        self.serialize_enum(self.ownershipStatus,outputStream)
        outputStream.write_byte(int(self.padding))

    def parse(self, inputStream):
        """"Parse a message. This may recursively call embedded objects."""
        self.entityId.parse(inputStream)
        self.ownershipStatus = OwnershipStatus.get_enum(self.parse_enum(self.ownershipStatus,inputStream))
