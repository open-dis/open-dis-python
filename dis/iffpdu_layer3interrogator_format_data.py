...
from .mode5interrogator_basic_data import Mode5InterrogatorBasicData
from .iffdata_specification import IFFDataSpecification
from .abstract_iffpdu_layer_data import AbstractIFFPduLayerData

class IFFPduLayer3InterrogatorFormatData( AbstractIFFPduLayerData ):
    """7.6.5.4.2 Layer 3 Mode 5 interrogator format"""

    def __init__(self):
        """ Initializer for IFFPduLayer3InterrogatorFormatData"""
        super().__init__()
        """ Layer header"""
        ...
        self.mode5InterrogatorBasicData = Mode5InterrogatorBasicData()
        """ Padding"""
        self.padding = 0
    ...
    def serialize(self, outputStream):
        """serialize the class """
        super( IFFPduLayer3InterrogatorFormatData, self ).serialize(outputStream)
        ...
        self.mode5InterrogatorBasicData.serialize(outputStream)
