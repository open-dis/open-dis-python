...
class LiveEntityOrientationError( object ):
    ...
    def to_string(self) ->str:
        outputString = ""
        outputString += "AzimuthError : " + str(self.azimuthError) + "\n"
    ...
    def serialize(self, outputStream):
        """serialize the class """
        outputStream.write_short(int(self.azimuthError))
        outputStream.write_short(int(self.elevationError))
        outputStream.write_short(int(self.rotationError))
