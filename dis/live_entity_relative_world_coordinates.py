...
class LiveEntityRelativeWorldCoordinates( object ):
    ...
    def serialize(self, outputStream):
        """serialize the class """
        outputStream.write_short(int(self.referencePoint))
        outputStream.write_short(int(self.deltaX))
        outputStream.write_short(int(self.deltaY))
        outputStream.write_short(int(self.deltaZ))
