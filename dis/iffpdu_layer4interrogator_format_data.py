...
from .mode_sinterrogator_basic_data import ModeSInterrogatorBasicData
from .iffdata_specification import IFFDataSpecification
from .abstract_iffpdu_layer_data import AbstractIFFPduLayerData

class IFFPduLayer4InterrogatorFormatData( AbstractIFFPduLayerData ):
    """7.6.5.5.2 Layer 4 Mode S interrogator format"""

    def __init__(self):
        """ Initializer for IFFPduLayer4InterrogatorFormatData"""
        super().__init__()
        """ Layer header"""
        ...
        self.modeSInterrogatorBasicData = ModeSInterrogatorBasicData()
        """ Padding"""
        self.padding = 0
    ...
    def serialize(self, outputStream):
        """serialize the class """
        super( IFFPduLayer4InterrogatorFormatData, self ).serialize(outputStream)
        ...
        self.modeSInterrogatorBasicData.serialize(outputStream)
