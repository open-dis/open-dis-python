...
class VectoringNozzleSystem( object ):
    ...
    def __init__(self):
        ...
        """ In degrees"""
        self.horizontalDeflectionAngle = 0.0
        """ In degrees"""
        self.verticalDeflectionAngle = 0.0
    ...
    def serialize(self, outputStream):
        """serialize the class """
        outputStream.write_float(int(self.horizontalDeflectionAngle))
        outputStream.write_float(int(self.verticalDeflectionAngle))
