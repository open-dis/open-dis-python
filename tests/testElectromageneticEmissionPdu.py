...
class TestElectromagneticEmissionPdu(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        self.assertEqual(15, pdu.systems[0].beamDataLength)
        self.assertEqual(1, pdu.systems[0].beamIDNumber)
        self.assertEqual(0, pdu.systems[0].beamParameterIndex)
        self.assertEqual(0, pdu.systems[0].beamParameterIndex)
        #self.assertAlmostEqual(9000000000, pdu.systems[0].fundamentalParameterData.frequency)
        self.assertEqual(0, pdu.systems[0].fundamentalParameterData.frequencyRange)
        self.assertEqual(70000, pdu.systems[0].fundamentalParameterData.effectiveRadiatedPower)
        self.assertEqual(0, pdu.systems[0].fundamentalParameterData.pulseRepetitionFrequency)
        self.assertEqual(0, pdu.systems[0].fundamentalParameterData.pulseWidth)
        self.assertEqual(0, pdu.systems[0].fundamentalParameterData.beamAzimuthCenter)
        ...
        self.assertEqual(1, pdu.systems[0].fundamentalParameterData.beamSweepSync)
        self.assertEqual(4, pdu.systems[0].beamFunction)
        self.assertEqual(1, pdu.systems[0].numberOfTargetsInTrackJam)
