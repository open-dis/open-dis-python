...
class TestEntityStatePdu(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        # Entity ID
        self.assertEqual(42, pdu.entityID.site)
        self.assertEqual(4, pdu.entityID.application)
        self.assertEqual(26, pdu.entityID.entity)
        ...
        # Entity Marking
        self.assertEqual("26        ", pdu.marking.characters)
